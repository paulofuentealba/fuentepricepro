...
export const ptBR = {
  ...
  dashboard: {
    kpi: {
      ...
      availableContributionSub: "Configurado em Metas",
    },
    fire: {
    ...
    matrix: {
      ...
      filterAll: "Todas as Classes",
      columnAsset: "Ativo",
      columnClass: "Classe",
      columnPrice: "Cotação Atual",
      columnCeiling: "Preço Teto Fuente",
      columnMargin: "Margem de Segurança",
      columnNetDy: "DY Líquido (12M)",
      columnTaxRegime: "Regime Tributário",
      columnAction: "Ação Recomendada",
      actionBuy: "Comprar",
