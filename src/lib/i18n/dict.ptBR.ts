...
export const ptBR = {
  ...
  taxRealityScreen: {
    ...
    summary: {
      ...
      fiiCgLabel: "Ganho de Capital — FIIs",
      fiiCgHelper: "Imposto devido sobre ganhos em vendas de FIIs (20% sem isenção de volume)",
      totalTaxLabel: "Imposto Total Estimado",
      totalTaxHelper: "Soma do imposto devido em ações e FIIs no ano (carryforwards não somados entre si)",
    },
    monthlyDetail: {
      stocksTitle: "Detalhe Mês a Mês — Ações",
      fiisTitle: "Detalhe Mês a Mês — FIIs",
      monthHeader: "Mês",
    ...
    limitsDeclared: {
      ...
      items: [
        ...
        "Ações no exterior (STOCK_US, REIT, ETF): ganho de capital segue regra própria (15% com compensação), não incluído.",
        "ETFs de ações (ambiguidade): tratamento como ação ou fundo ainda pendente de definição jurídica consolidada.",
        "FIIs fechados ou concentrados (>25% / <50 cotistas): exceção de isenção de ganho de capital não tratada.",
        "FIAGRO e FII_INFRA: equiparação ao regime de FII (Lei 14.130/2021 e Lei 12.431/2011) pendente de revisão jurídica expressa.",
