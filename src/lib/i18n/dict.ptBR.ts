...
export const ptBR = {
  ...
  taxRealityScreen: {
    ...
    summary: {
      ...
      totalTaxHelper: "Soma do imposto devido em ações, FIIs/FIAGROs e ETFs no ano (carryforwards não somados entre si)",
    },
    monthlyDetail: {
    ...
    limitsDeclared: {
      ...
      items: [
        ...
        "Ações e ativos no exterior (STOCK_US, REIT): ganho de capital segue regra própria, não incluído.",
        "ETFs de Renda Fixa: seguem tabela regressiva de renda fixa (IN RFB 1.585/2015), não calculados aqui. Esta tela apura apenas ETFs de renda variável (ações a 15% flat sem isenção de volume).",
