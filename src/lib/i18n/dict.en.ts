...
export const en = {
  ...
  taxRealityScreen: {
    ...
    summary: {
      ...
      fiiCgLabel: "Capital Gains — FIIs",
      fiiCgHelper: "Tax due on gains from FII sales (20% flat, no volume exemption)",
      totalTaxLabel: "Total Estimated Tax",
      totalTaxHelper: "Sum of tax due on stocks and FIIs for the year (carryforwards never summed across tracks)",
    },
    monthlyDetail: {
      stocksTitle: "Monthly Detail — Stocks",
      fiisTitle: "Monthly Detail — FIIs",
      monthHeader: "Month",
      salesHeader: "Sales (R$)",
    ...
    limitsDeclared: {
      ...
      items: [
        ...
        "Foreign stocks (STOCK_US, REIT, ETF): capital gains follow separate rule (15% with loss compensation), not included.",
        "Stock ETFs (ambiguity): treatment as stock or fund still pending consolidated legal definition.",
        "Closed or concentrated FIIs (>25% / <50 unitholders): capital gains exemption exception not handled.",
        "FIAGRO and FII_INFRA: equivalence to FII regime (Law 14.130/2021 and Law 12.431/2011) pending express legal review.",
