...
export const en = {
  ...
  valuationAssumptions: {
    ...
    bazinTooltipNetJcp: "Net JCP (15% IR withholding already deducted)",
  ...
  dividendRadar: {
    ...
    disclaimer: {
      ...
      body: "Combines Bazin Margin of Safety (DPS / 6% or 8%), Dividend Safety Score™ (0-100), and 5-year seasonality audited from CVM and SEC. Real Net DY deducts withholding taxes (30% in the US via W-8BEN and 15% in Brazil via JCP). Always review official issuer filings.",
    },
  ...
  irpfMirror: {
    ...
    exclusiveCard: {
      ...
      desc: "Interest on Equity (JCP) with 15% income tax already withheld at source. In the IRPF, declare the net received amount.",
      codeLabel: "Code 10 • Interest on Equity (JCP)",
      netReceived: "Net Received:",
      withheldTax: "Withheld Tax (15%):",
