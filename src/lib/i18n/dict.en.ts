...
export const en = {
  ...
  newsScreen: {
    ...
    digestModal: {
      ...
      description: "Receive an executive summary every Monday morning with announced dividends, thesis shifts, and buying opportunities across your portfolio.",
      emailLabel: "Delivery email",
      subscribedAlert: "You are currently subscribed to receive the weekly digest every Monday.",
      unsubscribedAlert: "Subscribe to receive portfolio changes and alerts weekly.",
      lgpdNotice: "We respect your privacy (LGPD/GDPR). You can unsubscribe at any time on this screen or in Settings > Privacy.",
      enableBtn: "Enable weekly digest",
      disableBtn: "Disable digest",
      closeBtn: "Close",
      loginRequired: "Please sign in to enable weekly email summaries.",
    },
  },
};
