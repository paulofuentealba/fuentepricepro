...
export const en = {
  ...
  previewOverlay: {
    ...
    smartAllocationBullet1: "Exact contribution suggestions to maximize passive income.",
  ...
  tooltips: {
    ...
    lynchNotApplicable: "Earnings per share (EPS) is not available for this asset, so the Peter Lynch model could not be calculated.",
    ...
    consensus: "Median of the valuation models applicable to this asset (Bazin, Graham, Gordon and/or Peter Lynch, depending on asset class).",
    ...
    taxExceptions: "Custom tax rate adjustment or tax exemptions applicable to dividends.",
  ...
  toasts: {
    ...
    adjustAllocationTarget100: "Adjust your allocation targets to 100% before generating suggestions.",
  ...
  demoBanner: {
    message: "You are exploring a simulated demo portfolio — changes will not be saved.",
    cta: "Sign in to start your real portfolio",
    reloadDemo: "Reload Demo Data",
    toastReloadSuccess: "Demo dataset updated successfully!",
  },
  demoPage: {
  ...
  authPage: {
    sideTitle1: "Does your portfolio know how to answer",
    sideTitle2: "what to do next?",
    sideSubtitle:
    ...
    sideFooter:
      "Calculation and organization tool. Not investment advice or securities advisory (CVM).",
    loginTitle: "Sign in to your account",
    loginSubtitle: "Continue where you left off.",
    signupTitle: "Create your account",
    signupSubtitle: "Free up to 8 assets. No credit card required.",
    continueGoogle: "Continue with Google",
    or: "or",
    rememberMe: "Remember me",
    forgotPassword: "Forgot password",
    forgotPasswordNeedsEmail: "Enter your email to reset your password.",
    forgotPasswordSent: "We've sent a password reset link to your email.",
    forgotPasswordError: "Couldn't send the reset email.",
    submitLogin: "Sign In",
  ...
  brokerNoteImportPage: {
    eyebrow: "{{count}} supported brokers",
    title: "Import broker note",
    back: "Back",
    uploadCardTitle: "Upload the note PDF",
    dragDropTitle: "Drag notes here",
    dragDropDesc: "Broker note PDFs · up to 20 files at once",
    autoDetectDesc: "We detect the broker automatically",
    supportedBrokers: "Supported brokers",
    usBrokersTitle: "US Brokers",
    brBrokersTitle: "Brazilian Brokers (B3)",
    toggleShowUsBrokers: "Show US brokers ({{count}})",
    toggleHideUsBrokers: "Hide US brokers",
    toggleShowBrBrokers: "Show Brazilian brokers ({{count}})",
    toggleHideBrBrokers: "Hide Brazilian brokers",
    privacyNote: "Your note is processed and discarded — we don't store the PDF, only the extracted transactions.",
    reviewCardTitle: "Detected transactions",
    detectedBroker: "Detected broker",
    feesRowLabel: "Fees and charges",
    feesRowDesc: "Prorated across trades",
    reviewWarningTitle: "Review before confirming.",
    reviewWarningDesc: "Transactions only enter your portfolio after confirmation — and recalculate your weighted average cost.",
    edit: "Edit",
    confirmN: "Confirm {{count}} transactions",
    confirmOne: "Confirm 1 transaction",
    signInToConfirm: "Sign in to confirm",
    unresolvedTickerPlaceholder: "Ticker (e.g. AAPL)",
    unresolvedBadge: "Confirm ticker",
    unitsLabel: "{{qty}} units",
    unitsLabelGeneric: "{{qty}} units",
    empty: "Upload a PDF to see the detected transactions here.",
  },
  corporateEvents: {
    ...
    bannerTitle: "Detected Corporate Events",
    bannerSubtitle: "Recent splits and groupings detected across your portfolio assets.",
    confirmedBadge: "Confirmed (2 sources)",
    singleSourceBadge: "Single source — Review needed",
    divergentBadge: "Source divergence",
    metric: "Metric",
    before: "Before",
    after: "After",
    delta: "Variation",
    ...
    fastPathButton: "Apply adjustment",
    slowPathButton: "Review event",
    applying: "Applying...",
    reviewSheetTitle: "Review Corporate Event",
    reviewSheetSubtitle: "Verify and adjust event parameters before consolidating into your portfolio.",
  ...
  form: {
    ...
    taxExceptions: "Tax Exceptions & Custom Rates",
    taxExceptionsPro: "Pro",
    taxExceptionsBody:
      "<strong>Automatic calculation:</strong> Standard tax withholding is applied automatically based on asset class and tax jurisdiction. Use this field only to override with a custom rate (e.g. specific tax treaties or local rules).",
    taxRateLabel: "Tax Rate (%)",
    taxRatePlaceholder: "Automatic default",
    ...
    advancedSettingsLockedDesc:
      "Free users cannot apply custom tax rates to calculations. Upgrade to Pro to customize taxation rules and exceptions!",
  ...
  result: {
    ...
    netProjectedTip: "Gross annual dividend minus applicable withholding tax based on your tax jurisdiction.",
  ...
  types: {
    STOCK_US: "US Stocks",
    STOCK_BR: "Brazil Stocks",
    REIT: "US REITs",
    FII: "Brazil Real Estate (FII)",
    FII_INFRA: "Brazil Infra (FII-Infra)",
    FIAGRO: "Brazil Agro (FIAGRO)",
    ETF: "ETFs",
  ...
  watchlist: {
    ...
    netIncome: "Net (after tax withholding)",
    netIncomeTip: "Net dividend after applicable withholding tax based on the asset and investor tax jurisdiction.",
    cagr5y: "CAGR (5Y)",
  ...
  explore: {
    ...
    descriptions: {
      screener: "Multi-criteria market screener for opportunities with Safety Margin, projected DY, and valuation multiples.",
      ...
      dividendRadar: "Predictive scanner and dividend seasonality with 360° sustainability score, Bazin ceiling price, and cash coverage.",
      snowball: "Dividend reinvestment simulator and wealth-compounding acceleration.",
      deepDive: "360° deep dive with class-specific metrics, dividend flow, custody position, and multi-model consensus.",
      myTransactions: "Consolidated ledger, order history, and accounting audit of all operations.",
    },
  },

  deepDive: {
    badge: "INDIVIDUAL ANALYSIS & FUENTE VALUATION",
    title: "Asset Deep Dive",
    subtitle: "360° view designed from the dividend investor's perspective: class-specific multiples, dividend flow, portfolio custody, and interactive Ceiling Price simulator.",
    categoriesTitle: "Select 1 representative asset from each of the 8 categories:",
    categoriesCount: "8 classes mapped",
    categoriesTitleUs: "Select a representative US dividend asset class:",
    categoriesCountUs: "5 US classes mapped",
    searchPlaceholder: "Search any ticker or asset from B3 / US (e.g. PETR4, TAEE11, AAPL, MXRF11)...",
    searchPlaceholderUs: "Search any US ticker or asset (e.g. O, AAPL, SCHD, KO, MSFT)...",
    currentPrice: "Current Price",
    fuenteCeiling: "Fuente Ceiling Price",
    safetyMargin: "Safety Margin",
    custodyTitle: "My Portfolio Position",
    custodyBadge: "PERSONAL CUSTODY",
    qtyInCustody: "Quantity in Custody",
    averagePrice: "Average Price",
    totalCurrentPosition: "Total Current Value",
    capitalGain: "Capital Gain / Loss",
    yieldOnCost: "Actual Yield on Cost (YoC)",
    dividendsReceived: "Dividends Received",
    sharesSuffix: "shares/units",
    sharesUsSuffix: "shares",
    custodyAt: "Held at:",
    refBroker: "Ref. Broker:",
    notInPortfolio: "Asset not in your portfolio",
    inYourPortfolio: "In your portfolio:",
    simulateHolding: "Simulate 100 shares",
    dividendIntelligenceBadge: "DIVIDEND FLOW & SNOWBALL",
    dividendIntelligenceTitle: "Dividend Intelligence",
    projectedDy: "Projected DY (Next 12M)",
    ...
    frequencies: {
      ...
      annual: "Annual",
      eightTimes: "8x per year",
      irregular: "Irregular / On Demand",
      accumulating: "No cash distribution (Accumulating)",
      autoReinvest: "Auto-Reinvestment",
      reinvestedInEtf: "Reinvested in ETF",
    },
    nextComDate: "Next Ex-Dividend Date",
    nextPayment: "Payment Date & Amount",
    snowballTitle: "Snowball Effect (Self-Funding)",
    snowballText: "Every cycle, {{qty}} shares generate enough dividends to automatically purchase 1 new share.",
    consensusBadge: "MULTI-METHODOLOGICAL VALUATION • 4 CLASSIC MODELS",
    consensusTitle: "Fuente Consensus Ceiling Price Matrix",
    consensusDescription: "Cross-analysis of Bazin, Graham, Gordon, and Peter Lynch models to eliminate single-formula bias.",
    consensusCeiling: "Fuente Consensus Ceiling Price",
    avgSafetyMargin: "Average Safety Margin",
    methodConvergence: "Methodological Convergence",
    approvalsCount: "{{count}} of 4 Approve",
    highConvergence: "High Convergence • Low Profiled Risk",
    mixedConvergence: "Mixed Convergence • Calibrate",
    conservativeFloor: "Conservative Floor",
    weightedConsensus: "Weighted Consensus",
    optimisticCeiling: "Optimistic Ceiling",
    bazinFormula: "Div / Target Yield",
    grahamFormula: "√(22.5 × EPS × BVPS)",
    gordonFormula: "D1 / (k - g)",
    lynchFormula: "EPS × Growth g",
    belowCeiling: "Below Ceiling",
    aboveCeiling: "Above Ceiling",
    bazinCardSub: "Min. yield calibrated at {{yield}}% with historical DPS",
    grahamCardSub: "Classic formula: √(22.5 × EPS × BVPS) with margin of safety",
    gordonCardSub: "Discount Model: D1 / (k: {{k}}% - g: {{g}}%)",
    lynchCardSub: "Fair value based on PEG parity with growth and DY",
    ...
    savingAssumptions: "Saving assumptions...",
    assumptionsTitle: "Global Assumptions Adjustment (Real-Time)",
    bazinYieldLabel: "Bazin Minimum Yield",
    gordonDiscountLabel: "Gordon Discount Rate (k)",
    perpetualGrowthLabel: "Perpetual Growth Rate (g)",
    applyConsensusBtn: "Apply Consensus to Contribution Engine",
    appliedSuccess: "Asset {{ticker}} synchronized with Fuente Consensus!",
    ...
    taxPassports: {
      ...
      brStock: "<strong>Income:</strong> Stock dividends are exempt from Brazilian personal income tax for individual retail investors (with a 10% withholding only on amounts exceeding R$ 50,000/month from a single payer under Law 15.270/2025). Interest on Equity (JCP) is subject to 17.5% exclusive withholding tax at source (Law 15.270/2025 / LC 224/2025).<br><strong>Capital Gains:</strong> Equity sales up to R$ 20,000/month on the spot market are tax-exempt. Above this threshold, 15% flat rate applies on net profit (20% for day trade).",
  ...
  smartAllocation: {
    ...
    assetClassExplainers: {
      STOCK_BR: "Brazilian equities (B3) — equity ownership in Brazilian public companies and their earnings.",
      FII: "Brazilian Real Estate Funds (FIIs) — commercial property and credit portfolios distributing regular income.",
      STOCK_US: "US equities (NYSE/Nasdaq) — equity ownership in global publicly traded companies.",
      REIT: "Real Estate Investment Trusts (REITs) — companies that own income-producing real estate and distribute operating cash flows to shareholders.",
      ETF: "Exchange-Traded Funds (ETFs) — diversified baskets of assets tracking market indexes, sectors, or strategies.",
      FIXED_INCOME: "Fixed Income — government and corporate debt securities (Treasuries, bonds, notes) with predefined yields and terms.",
  ...
  onboardingPersonalInfo: {
    ...
    subtitle: "Optional — helps personalize your experience. You can skip and fill this in later in Settings.",
    subtitleNameRequired: "What should we call you? City and country are optional.",
    ...
    continueBtn: "Finish",
    savedToast: "Saved!",
    errorToast: "Couldn't save your data.",
  },
  ...
  snowballScenario: {
    ...
    projectionBadge: "{{years}}-year simulation",
    monthlyIncomeLine: "income of {{amount}}/mo",
      ...
      questions: {
        ...
        items: [
          ...
          },
          {
            ...
            desc: "30% withheld in the US, 17.5% on JCP, REITs tax-exempt. Gross yield is fiction — we show the real net.",
          },
          {
  ...
  settings: {
    ...
    profile: {
      ...
      investorCard: {
        ...
        answeredOnLabel: "Answered on",
        noProfileTitle: "You haven't answered the questionnaire yet",
        noProfileDesc: "Answer 4 quick questions to get a personalized allocation suggestion.",
        startBtn: "Take the questionnaire",
        goalsLink: "View goals and criteria →",
        narrativeTitles: {
          conservative: { income: "Income with security", growth: "Growth with caution" },
          moderate: { income: "Income with balance", growth: "Growth with balance" },
          aggressive: { income: "Income with boldness", growth: "Aggressive growth" },
        },
        riskToleranceLabels: {
    ...
    subscription: {
      ...
      featureAssetsUnlimited: "Unlimited",
      featureTaxReality: "Tax reality",
      featureWithdraw: "Withdraw with least impact",
      featureAudit: "Audit",
      featureImport: "Broker note import",
      featureActive: "✓ Active",
      featureInactive: "Available on Pro",
    ...
    privacy: {
      ...
      dataCardPill: "GDPR/LGPD",
      dataCardDesc: "You can export everything we store about you, at any time, in a machine-readable format.",
      exportJsonBtn: "Export my data (JSON)",
      exportCsvBtn: "Export portfolio (CSV)",
      exportJsonSuccess: "Your data has been exported.",
      exportCsvSuccess: "Portfolio exported.",
      disclaimerAcceptanceLabel: "Regulatory disclaimer acceptance:",
  ...
  addAssetPage: {
    ...
    title: "Add asset",
    back: "Back",
    searchCardTitle: "Search asset",
    searchLabel: "Ticker or name",
    bonificacao: "Stock dividend",
    bonificacaoDisabledHint: "Coming soon — register stock dividends from the asset detail screen.",
    submit: "Add to portfolio",
    impactCardTitle: "How this affects your portfolio",
    impactBadge: "preview",
    newAveragePrice: "New average cost",
    positionAfter: "Total position after",
    positionUnit: "{{qty}} units",
    investedValue: "Invested value",
    estimatedMonthlyIncome: "Estimated monthly income",
    allocationAfter: "{{class}} after",
    allocationTarget: "(target {{target}}%)",
    impactEmpty: "Pick an asset and fill in quantity and price to see the preview.",
    consensusCardTitle: "Consensus on date",
    consensusBadgeRegistered: "recorded",
    consensusBadgeUnavailable: "unavailable",
    consensusDesc: "We record the consensus and fundamentals on the purchase date. That's what lets us show, later, whether the thesis changed.",
    consensusLabel: "Consensus",
    marginLabel: "Margin",
    payoutLabel: "Payout",
    consensusUnavailable: "Consensus unavailable for this asset on the given date.",
  },
  onboarding: {
    country: {
      eyebrow: "Welcome",
      title: "Where do you invest?",
      sub: "This tailors the next questions and your suggested allocation — no jargon that doesn't apply to your market.",
      br: { name: "Brazil", note: "BRL · CDI/Selic · FIIs" },
      us: { name: "United States", note: "USD · T-Bills · REITs" },
    },
    questions: {
      ...
      horizon: {
        ...
        sub: "Think about your main goal — it doesn't need to be exact.",
        options: {
          under1: { title: "Less than 2 years", desc: "Short-term / near-term liquidity" },
          oneToThree: { title: "2 to 5 years", desc: "Medium-term goal" },
          threeToFive: { title: "5 to 10 years", desc: "Long-term wealth building" },
          over5: { title: "10+ years", desc: "Retirement / multi-decade compounding" },
        },
      },
      risk: {
        eyebrow: "2 of 4",
        title: "Your portfolio drops 20%. What do you do?",
        sub: "Picture this happening during a normal market correction.",
        options: {
          sell: { title: "Sell everything", desc: "Move to cash to avoid further losses" },
          sellPart: { title: "Sell part of it", desc: "Shift a portion to safer assets" },
          hold: { title: "Do nothing", desc: "Wait for recovery, stick to the plan" },
          buy: { title: "Buy more", desc: "View it as an opportunity" },
        },
      },
      knowledge: {
        eyebrow: "3 of 4",
        title: "How would you describe your experience?",
        sub: "Be honest — this only shapes your starting suggestion.",
        options: {
          beginner: { title: "Novice", desc: "Savings, CDs, target-date defaults" },
          basic: { title: "Basic", desc: "Bond yields, T-Bills, index funds" },
          intermediate: { title: "Intermediate", desc: "Stocks, sector ETFs, REITs, bonds" },
          advanced: { title: "Advanced", desc: "Options, factor investing, tax-loss harvesting" },
        },
      },
      goal: {
        eyebrow: "4 of 4",
        title: "What's your primary objective?",
        sub: "Last question — we're already calculating your suggestion.",
        options: {
          preserve: { title: "Capital preservation", desc: "Minimal nominal risk, above all" },
          protect: { title: "Inflation protection", desc: "Moderate gains, low volatility" },
          both: { title: "Balanced growth", desc: "Income plus appreciation" },
          growth: { title: "Maximum growth", desc: "Accepting volatility along the way" },
        },
      },
    },
    result: {
      eyebrow: "Your profile",
      subtitle: "Based on your answers, here's a starting point — fully adjustable.",
      finishBtn: "Finish",
      retakeBtn: "Retake Questionnaire",
      profileLabel: "Investor Profile",
      applyBtn: "Apply this allocation",
      appliedBtn: "Applied!",
      manualBtn: "I'll adjust it manually",
      notice: "You can review and change this anytime in Goals & Criteria. Nothing has been applied yet.",
      tiers: {
        conservative: "Conservative",
        moderate: "Moderate",
        aggressive: "Aggressive",
  ...
  dashboard: {
    kpi: {
      netWorth: "Real Net Worth",
      netWorthSub: "Portfolio accumulated return",
      weightedYoc: "Average Net Yield on Cost",
      weightedYocSub: "Yield weighted by average cost across all active portfolio positions",
      monthlyIncome: "Estimated Monthly Income",
      monthlyIncomeSub: "12-Month Projection: {{projection}}",
      availableContribution: "Available Contribution Power",
      availableContributionSub: "Active Rebalancing Ready",
    },
    fire: {
      eyebrow: "Financial Independence Gauge",
      title: "Living Cost Coverage by Passive Income",
      subtitle:
        "Track progress toward the Crossover Point (the moment your income covers 100% of your fixed costs).",
      crossoverLabel: "Estimated Crossover Point",
      crossoverReached: "Reached",
      crossoverUnknown: "Set your goal",
      monthlyCostLabel: "Set your Monthly Living Cost:",
      currentIncomeLabel: "Current Monthly Income:",
      coverageLabel: "Coverage Rate:",
      gapText: "{{amount}}/month left to reach 100% Autonomy",
      goalReachedText: "100% autonomy goal reached!",
      startLabel: "0% (Start of Journey)",
      targetLabel: "100% (Crossover Point)",
      milestone25: "25% coverage",
      milestone50: "50% coverage",
      milestone75: "75% coverage",
      milestone100: "100% — Crossover Point",
      milestonePhase1: "Phase 1: Survival / Utilities",
      milestonePhase1Desc: "Electricity, condo fees, internet & gas",
      milestonePhase2: "Phase 2: Basic Essentials",
      milestonePhase2Desc: "Food, healthcare & essential housing",
      milestonePhase3: "Phase 3: Lifestyle (Full)",
      milestonePhase3Desc: "All fixed costs + monthly leisure",
      milestonePhase4: "Phase 4: Fat FIRE / Abundance",
      milestonePhase4Desc: "Complete freedom, travel & max security",
      milestoneAchieved: "REACHED",
    },
    contribution: {
      eyebrow: "Contribution Plan • Smart Suggestion",
      title: "Where should my next contribution go?",
      amountLabel: "Amount to contribute",
      suggestionNote:
        "Suggestion calculated based on assets below the Fuente Ceiling Price and the drift from your allocation goal.",
      targetsNotConfigured: "Set your allocation targets to receive contribution suggestions.",
      noEligibleAssets: "No eligible asset found for that amount.",
      insufficientFunds: "Enter a contribution amount to see suggestions.",
      leftover: "Unallocated leftover: {{amount}}",
      calculatedSuggestion: "Calculated suggestion:",
      calculatedSuggestionDesc:
        "Based strictly on assets below the Fuente Ceiling Price and drift from your target allocation.",
    },
    allocation: {
      ...
      target: "Target",
      current: "Current",
      empty: "Set your per-class allocation targets in Goals.",
      statusPrioritary: "Priority Contribution",
    ...
    matrix: {
      eyebrow: "Unified Asset Matrix",
      title: "Ceiling Price & Opportunity Radar",
      filterAll: "All 8 Classes",
      filterAllDynamic: "All Classes",
      columnAsset: "Asset",
      columnClass: "Class",
      columnPrice: "Price",
      ...
      actionOk: "BUY OK",
      actionWatch: "HOLD",
      actionAvoid: "QUARANTINE",
      actionYieldTrap: "Warning: Yield Trap",
      actionNoData: "No data",
      empty: "No assets found in this class.",
    },
    taxRegime: {
      exemptDouble: "Double Exemption (Law 12.431)",
      exemptDividend: "Tax-Exempt (Law 11.033)",
      exemptStockBr: "Exempt (Dividends) / 17.5% (JCP)",
      whtCompensable: "30% WHT Creditable",
      jcpWithholding: "17.5% Withholding at Source (JCP)",
  ...
  portfolio: {
    ...
    statusBelowCeiling: "Below Ceiling",
    statusAboveCeiling: "Above Ceiling",
    exportCsv: "Export Positions (CSV)",
    positionsTitle: "Detailed Portfolio Positions Breakdown",
    positionsSubtitle: "Automatic calculation of unrealized profit/loss and real Yield on Cost (YoC).",
    ...
    fx: {
      eyebrow: "INTERNATIONAL RETURN ANALYSIS • ASSET VS FX",
      title: "FX Decomposition of US Assets",
      subtitle:
        "Mathematical breakdown: know exactly how much of your gain came from Wall Street equities vs Dollar (USD/BRL) appreciation.",
      avgFxRateLabel: "Average USD Exchange Rate:",
      currentFxRateLabel: "Current:",
      kpiAssetReturnTitle: "Asset Return in Hard Currency (USD)",
      kpiAssetReturnSub: "Pure Wall Street gain",
      kpiFxGainTitle: "Accumulated FX Gain (USD/BRL)",
      kpiFxGainSub: "Remittances at avg cost vs current PTAX",
      kpiTotalReturnTitle: "Consolidated Compound Return (BRL)",
      kpiTotalReturnSub: "Total profit in BRL",
      columnAssetUs: "US Asset",
      columnAvgCostUsd: "Avg Cost USD",
      columnCurrentPriceUsd: "Current Price USD",
      columnAssetReturnUsd: "Asset Return (USD)",
      columnAvgFx: "Avg FX",
      columnFxEffect: "FX Effect",
      columnTotalReturnBrl: "Total Return BRL",
      columnDiagnosis: "Fuente Diagnosis",
      radarTitle: "Tactical FX Radar:",
      radarAboveMa: "Current PTAX ({{current}}) is {{diff}} above 200-day moving average ({{ma}}).",
      radarBelowMa: "Current PTAX ({{current}}) is {{diff}} below 200-day moving average ({{ma}}).",
      radarIdealB3: "Ideal Moment: Contribute to B3 or use USD in Custody",
      radarIdealUS: "Ideal Moment: Favorable rate to remit and invest in USD",
      diagDoubleGain: "Double Gain (Asset + Dollar)",
      diagAssetDominant: "Asset Growth Dominant",
      diagFxProtective: "Protective FX Gain",
      diagHedgeCompensated: "FX Hedge Offset Decline",
      diagStable: "Stable Performance",
      noUsAssets: "No international assets in portfolio for FX decomposition.",
    },
  },
  admin: {
    ...
    featureGates: {
      ...
      taxRealityUnlocked: "Tax Reality",
      taxRealityUnlockedDesc: "Unlock the Tax Reality screen (dividends, stock capital gains, and FII capital gains aggregation).",
      save: "Save changes",
  ...
  valuationAssumptions: {
    ...
    simpleModeDesc: "Executive view with ceiling price and safety margin",
    advancedModeDesc: "Granular control of each assumption with sliders",
    updating: "Updating valuation...",
    // Method tooltips
    whyThisNumber: "Why this number?",
    gordonTooltipTitle: "Gordon Model (DDM H-Model)",
    gordonTooltipFormula: "Formula: D₁ / (r - g)",
    gordonTooltipRate: "Discount rate (r): {{rate}}%",
    ...
    bazinTooltipNetJcp: "Net JCP (17.5% IR withholding already deducted)",
    bazinTooltipDividend: "Tax-free dividend",
    bazinTooltipSource: "Source: {{source}}, date: {{date}}",
    grahamTooltipTitle: "Graham Model (Intrinsic Value)",
    grahamTooltipFormula: "Formula: √(22.5 × EPS × BVPS)",
    grahamTooltipMargin: "Safety margin applied: {{margin}}%",
    grahamTooltipSource: "Source: SEC EDGAR, EPS/BVPS date: {{date}}",
    ...
    consensusTooltipTitle: "Fuente Consensus (Median)",
    consensusTooltipMethods: "Methods included in median: {{methods}}",
    consensusTooltipExcluded: "Excluded: {{excluded}}",
  ...
  askEngine: {
    strategies: {
      ...
      buyDiscount: "Buy Discount",
    },
    reasons: {
      farthestBelowTarget: "Asset class {{classType}} furthest below target ({{margin}}% margin)",
      positiveSafetyMargin: "Positive safety margin ({{margin}}%) versus ceiling price",
      excludedAboveCeiling: "Market price R$ {{price}} is above ceiling R$ {{ceiling}} ({{margin}}% margin)",
      ...
      highestNetYield: "Highest net dividend yield ({{yield}}%) among eligible assets",
      reinforcePayer: "Direct reinvestment into {{ticker}} (dividend payer)",
    },
    consequences: {
      annualIncomeAdded: "Estimated annual income added: R$ {{value}}",
      annualIncomeAddedLabel: "Annual income added",
    },
  },
  withdrawEngine: {
    reasons: {
      fiiInfraExempt: "FI-Infra is 100% tax-exempt (Lei 12.431/2011)",
      realizesLoss: "Realizes a loss — reduces tax on the month's remaining sales",
      stockWithinExemption: "Keeps stock sales within the R$20k/month exemption",
      smallestTaxableGain: "Smallest taxable gain among the eligible assets",
      lowestYieldOnCost: "Lowest yield on cost — preserves your future income",
      aboveCeiling: "{{margin}}% above the consensus ceiling price",
    },
  },
  screenerScreen: {
    eyebrow: "FUENTE PRICE PRO · SCREENER",
    title: "Market Fundamental Screener",
    ...
    marketBr: "Brazil (B3)",
    marketUs: "US (Global)",
    monitoredCount: "{{count}} monitored assets",
    marketBadgeUs: "US MARKET",
    marketBadgeBr: "B3 BRAZIL",
    marketBadgeAll: "B3 + US GLOBAL",
    classLabel: "Asset Class",
    allClasses: "All Classes",
    marginLabel: "Safety Margin",
    allMargins: "All Margins",
    marginPositive: "Below Ceiling (> 0%)",
    marginSafe: "Safe Margin (> 10%)",
    marginDeep: "Deep Discount (> 20%)",
    dyLabel: "Dividend Yield",
    allDy: "Any DY",
    dy4: "DY > 4% p.a.",
    dy6: "DY > 6% p.a. (Bazin)",
    dy8: "DY > 8% p.a. (High Income)",
    dy10: "DY > 10% p.a. (Super Yield)",
    pvpLabel: "P/B (P/VP)",
    allPvp: "Any P/B",
    pvpDiscount: "Below Book Value (< 1.0)",
    pvpFair: "Near Book Value (< 1.2)",
    sortLabel: "Sort by",
    sortMarginDesc: "Highest Safety Margin",
    sortDyDesc: "Highest Dividend Yield",
    sortPvpAsc: "Lowest P/B",
    sortTickerAsc: "Ticker (A-Z)",
    filtersTitle: "Fundamental Filters",
    filterSearchPlaceholder: "Filter by ticker or name...",
    kpis: {
      totalAnalyzed: "Covered Assets",
      undervaluedCount: "Below Ceiling",
      avgMargin: "Average Margin",
      avgDy: "Average Projected DY",
    },
    table: {
      asset: "Asset / Company",
      class: "Class",
      ...
      noResults: "No assets found matching the selected filters.",
      clearFilters: "Clear Filters",
      addCustomTicker: "Didn't find what you're looking for? Type in the search box to analyze any B3 or US ticker.",
    },
    simulatorModal: {
      title: "Portfolio Impact Simulator",
      subtitle: "Instantly calculate the impact of this contribution on your asset allocation and future portfolio income.",
      amountLabel: "Contribution Amount",
      closeBtn: "Close",
      viewFullDeepDive: "View Full Analysis in Deep Dive",
    },
    amountLabel: "I'm putting in",
    vsConsensus: "vs. consensus",
    impactLabel: "What {{amount}} here changes in your portfolio",
    allocLabel: "Class allocation",
    incomeLabel: "Projected monthly income",
    deviationLabel: "Deviation from goal",
    noTargetsPrompt: "Set your class allocation goals to see how this fits.",
    configureGoalsLink: "Set up goals →",
    emptyTitle: "No assets in your portfolio yet",
    emptyDesc: "Search a ticker to simulate your first contribution.",
    reasons: {
      yieldTrap: "Yield trap signal: DY is far above the asset's own historical average.",
      aboveCeiling: "Price already passed consensus — you'd be buying above what the 3 methods justify today.",
      alreadyHeld: "Already your position — reinforces an asset already in your portfolio.",
      belowTarget: "You're {{deviation}} pp below the goal in {{className}} — this reduces that gap.",
      withinTarget: "Your {{className}} class is already at goal — within the criteria you set.",
      noTargets: "Set your class allocation goals in Goals & Criteria to see how this fits.",
    },
  },
  askScreen: {
    reinvestTitle: "Reinvest Dividends",
    reinvestSubtitle: "Decision engine to allocate received dividend cash-flow according to your criteria",
    reinvestQuestion: "Where to allocate your dividends to maximize passive income compounding?",
    reinvestQuestionLead: "Dividends just landed in your account.",
    reinvestQuestionEmphasis: "Where do I reinvest, without leaving it idle?",
    availableAmountLabel: "Amount available to reinvest",
    availableAmountHelper: "Suggestion based on net dividends received this month (editable)",
    contributionTitle: "Contribution Plan",
    contributionSubtitle: "Decision engine to allocate a new contribution according to your criteria",
    contributionQuestion: "I have this amount to invest. Where does it go, given what I already hold?",
    contributionQuestionLead: "I have this amount to invest.",
    contributionQuestionEmphasis: "Where does it go, given what I already hold?",
    availableAmountLabelContribution: "Contribution amount",
    ...
    featureGateBlockedTitleContribution: "Contribution Engine Blocked",
    featureGateBlockedDescContribution: "The contribution plan engine is temporarily under maintenance.",
    sharesUnit: "shares",
    leftoverLabel: "Leftover",
    addedIncomeLabel: "Added income",
    belowCeilingLabel: "Below ceiling",
    belowCeilingOfLabel: "of",
    consequencesTitle: "Projected Impact",
    noTargetsConfiguredTitle: "Allocation targets not configured",
    noTargetsConfiguredDesc: "The Correct Drift strategy requires target percentages configured per asset class. You can set them in Settings or use the other strategy tabs.",
    configureTargetsBtn: "Configure Targets",
    reinforceNoPayerTitle: "No specific payer selected",
    reinforceNoPayerDesc: "This strategy reinvests into the specific asset that generated the dividend. Use the tabs above to reinvest across your portfolio.",
    noEligibleAssetsTitle: "No eligible assets found",
    noEligibleAssetsDesc: "All assets were excluded based on your ceiling price or risk criteria.",
    insufficientFundsTitle: "Insufficient funds",
    insufficientFundsDesc: "The available amount is less than 1 whole share of any eligible asset.",
    excludedAssetsTitle: "Assets excluded by your criteria ({{count}})",
    washSaleWarningTitle: "Wash Sale Risk (IRC § 1091)",
    washSaleWarningDesc: "Sold {{ticker}} at a loss within the last 30 days. Purchasing now may disallow ~{{loss}} in tax loss deduction ({{days}} days remaining in 30-day window).",
    rankHeader: "Rank",
    tickerHeader: "Asset",
    reasonHeader: "Calculation Reason",
    allocationHeader: "Suggested Allocation",
    exportBtn: "Export Plan",
    featureGateBlockedTitle: "Reinvestment Engine Locked",
    featureGateBlockedDesc: "The reinvestment engine is currently undergoing maintenance.",
    withdrawTitle: "Withdraw with the least impact",
    withdrawSubtitle: "Tax simulation",
    withdrawQuestionLead: "I need to take money out.",
    withdrawQuestionEmphasis: "Where from, losing the least?",
    withdrawAmountLabel: "I need",
    withdrawStrategyMinimizeTax: "Lowest tax",
    withdrawStrategyMinimizeIncomeLoss: "Least income lost",
    withdrawStrategySellOverpriced: "Sell what's overpriced",
    withdrawHintMinimizeTax: "uses exemption and losses",
    withdrawHintMinimizeIncomeLoss: "preserves dividends",
    withdrawHintSellOverpriced: "above ceiling",
    withdrawTaxSuffix: "in tax",
    withdrawEstimatedTaxLabel: "Estimated tax",
    withdrawEstimatedTaxTooltip: "Simulation of capital gains tax due following taxable position liquidation.",
    withdrawEstimatedTaxTooltipUS: "Simulation of estimated capital gains tax due following position liquidation.",
    withdrawIncomeLostLabel: "Income lost",
    withdrawIncomeLostTooltip: "Estimated annual reduction in your passive dividend income resulting from this sale.",
    withdrawLossOffsetLabel: "Loss offset",
    withdrawLossOffsetTooltip: "Prior carried-forward capital losses applied to offset or eliminate the tax liability.",
    withdrawNoEligibleAssetsTitle: "No position eligible for sale",
    withdrawNoEligibleAssetsDesc: "Add assets to your portfolio or enter an amount to withdraw to calculate the sell order.",
    withdrawInsufficientPosition: "Your portfolio doesn't cover the amount requested — {{amount}} still short.",
    withdrawInsightTitle: "Sell order matters more than the amount",
    withdrawInsightDesc: "In this order you stay under the {{exemption}}/month exemption and use {{carryforward}} of accumulated losses. In another order, the same withdrawal could generate {{altTax}} in tax.",
    withdrawInsightDescUS: "In this order you utilize {{carryforward}} of carried-forward losses to offset taxable gains. In another order, the same withdrawal could generate {{altTax}} in tax.",
    withdrawFeatureGateBlockedTitle: "Withdraw Engine Locked",
    withdrawFeatureGateBlockedDesc: "The withdraw engine is currently undergoing maintenance.",
  },
  incomeScreen: {
    eyebrow: "Ex-date passed · amount announced",
    title: "Guaranteed income",
    insightTitle: "This isn't a projection. It's money already contracted.",
    insightDesc: "You've already earned the right to these dividends — the ex-date passed and the amount was announced. Only the payment date is still pending.",
    upcomingCardTitle: "Already guaranteed · {{days}} days",
    ...
    daysUnit: "{{days}} days",
    todayLabel: "today",
    netFootnote: "Net accounts for applicable withholding taxes and deductions based on asset and investor tax jurisdiction. Estimate — confirm with your accountant.",
    upcomingEmptyTitle: "No confirmed payments in the next {{days}} days",
    upcomingEmptyDesc: "Once a dividend's ex-date passes and the payer announces the amount, it shows up here.",
    weakMonthsCardTitle: "Your dry months",
    weakMonthsBadge: "{{count}} weak months",
    weakMonthsBadgeSingle: "1 weak month",
    weakMonthsDesc: "Your top {{count}} holdings ({{tickers}}) pay in the same months. {{months}} earn less than {{amount}}.",
    weakMonthsNone: "Every month has at least one of your top holdings paying — no dry spells detected.",
    weakMonthsEmpty: "Not enough payment history yet to detect dry months.",
    weakMonthsLink: "See assets that pay in the dry months →",
    annualCardTitle: "Dividends by year",
    annualCardTitleMonthly: "Dividends by month in {{year}}",
    annualBackLabel: "Dividends by year",
    annualTapHint: "Tap a bar to see the month-by-month breakdown",
    annualGrowthBadge: "↑ {{rate}}% / year · {{years}}-year average",
    annualLegendReceived: "Received",
    annualLegendProjected: "Projected through Dec/{{year}}",
    annualLegendProjectedMonth: "Projected",
    annualGrowthStat: "+{{pct}}% since {{year}}",
    annualMonthlyTotalStat: "Year total: {{total}}",
    annualEmptyTitle: "No dividend history yet",
    annualEmptyDesc: "Once you've received your first dividends, the year-by-year chart shows up here.",
    annualMonthlyEmptyTitle: "No income in {{year}}",
    annualMonthlyEmptyDesc: "There are no dividends received or projected for this year.",
    monthTickerTapHint: "Tap a month to see who paid",
    monthTickerReceived: "Received",
    monthTickerAnnounced: "Announced",
    monthTickerEmpty: "No per-asset announcement for this month yet — the bar's amount is a model projection.",
    taxTypeDividend: "Dividend",
    taxTypeJcp: "JCP (Interest on Equity)",
    taxTypeRendimentoFii: "REIT Income",
    taxTypeUsDividend: "US Dividend",
    featureGateBlockedTitle: "Income Screen Locked",
    featureGateBlockedDesc: "The guaranteed income screen is currently undergoing maintenance.",
    stressTest: {
      eyebrow: "CASH FLOW STRESS TEST",
      title: "Crisis Simulator & Dividend Resilience",
      description: "Simulate the impact of profit cuts and dividend suspensions on your monthly cash flow.",
      presets: {
        normal: "Normal (0%)",
        normalDesc: "Projected cash flow without shocks",
        moderate: "Moderate Drop (-15%)",
        moderateDesc: "Earnings slowdown",
        severe: "Severe Cut (-30%)",
        severeDesc: "Commodity crisis / high interest rates",
        extreme: "Extreme Shock (-50%)",
        extremeDesc: "Systemic crisis (2008/2020 style)",
      },
      sliderLabel: "Hypothetical Cut Intensity:",
      sliderStops: {
        base: "0% (Base Scenario)",
        moderate: "-25% (Moderate Cut)",
        crisis: "-50% (Crisis)",
        catastrophe: "-70% (Catastrophe)",
      },
      metrics: {
        stressedIncome: "Monthly Income Under Stress",
        vsProjected: "vs {{amount}} projected",
        budgetImpact: "Budget Impact (Loss)",
        lossPerMonth: "-{{amount}}/mo",
        lossPerYear: "-{{amount}} per year",
        livingCostCoverage: "Living Cost Coverage",
        targetCost: "Base target of {{amount}}/mo",
      },
      diagnosis: {
        normal: "Portfolio in normal cashflow rhythm.",
        surviving: "Shielded portfolio: Even with a {{cut}}% cut, your income continues covering essential costs.",
        deficit: "Deficit warning: In a {{cut}}% cut, your dividends would cover only {{pct}}% of your target cost.",
        recommendation: "Smart recommendation: To protect against dividend cuts, prioritize assets with a Dividend Safety Score above 80 (Dividend Kings, Aristocrats, and utilities) and balance with Treasuries or short-duration fixed income.",
      },
    },
    cashflowTimeline: {
      eyebrow: "CASH CALENDAR • {{month}} {{year}}",
      title: "Monthly Dividend Timeline",
      description: "Projected payouts and ex-dividend dates by week in the current month.",
      monthlyTotal: "Projected Total This Month",
      emptyState: "No dividends scheduled specifically for this month yet. Check upcoming months in the Annual Seasonality table below.",
      weeks: {
        w1: "Week 1 (Days 01 to 07)",
        w2: "Week 2 (Days 08 to 14)",
        w3: "Week 3 (Days 15 to 21)",
        w4: "Week 4+ (Days 22 onwards)",
      },
      status: {
        paid: "Paid",
        pending: "Upcoming",
  ...
  dividendSafetyRadar: {
    ...
    badgeTooltipTitle: "Dividend Safety Radar",
    cutRiskLabel: "Statistical cut risk:",
  },
  dividendRadar: {
    title: "360° Dividend Radar & Tactical Calendar",
    eyebrow: "Institutional Fusion · Safety Score 360° + Bazin Margin + Jan-Dec Seasonal Calendar",
    marketsBadge: "★ Markets: B3 + NYSE / Nasdaq",
    viewMode: {
      cards: "Cards View",
      table: "Pro Table View",
    },
    gapFinder: {
      title: "Gap Finder — Dry Months Coverage & Dividend Safety",
      descriptionWithGaps: "Your portfolio currently receives less than {{amount}} in {{months}}. Filter the months below to discover assets with Dividend Safety Score > 80 and historical consistency below Bazin Ceiling Price.",
      descriptionNoGaps: "Identify tactical opportunities in peak dividend months across B3 and global markets (May and November). Assets with high historical consistency and positive margin of safety.",
      ctaFill: "⚡ Fill Month of {{month}}",
      radarCount: "{{count}} assets",
      radarCountSub: "in tactical radar",
    },
    seasonality: {
      title: "Expected Announcement Timeline (Click a month to filter cashflow):",
      statusAll: "Displaying: All months ({{count}} monitored assets)",
      statusMonth: "Displaying: Month of {{month}} ({{count}} assets with historical window)",
      allMonths: "ALL",
    ...
    card: {
      ...
      windowCom: "Expected Ex-Date:",
      investBtn: "+ Contribute",
      auditBtn: "Audit Risk",
      belowCeiling: "below ceiling",
      aboveCeiling: "above ceiling",
      scoreSuffix: "/100",
    ...
    table: {
      colAsset: "Asset",
      colPrice: "Price",
      colCeiling: "Ceiling Price",
      colMargin: "Margin",
      colDyGross: "Gross DY",
      colDyNet: "Net Real DY (Pocket)",
      colPayout: "FCF Payout",
      colScore: "Safety Score",
      colNextMonth: "Expected Month (5y)",
      colWindowCom: "Next Ex-Date",
      colAction: "Action",
    },
    detailSheet: {
      title: "Dividend & Valuation Deep Dive",
      statusRadar: "Radar Status",
      bazinDecomposition: "Bazin Ceiling Price Breakdown",
      dpa: "Projected Average Dividend (DPS)",
      targetYield: "Minimum Target Yield Required",
      formulaBazin: "Formula: DPS ÷ Target Yield",
      currentPrice: "Current Market Price",
      effectiveMargin: "Effective Margin of Safety",
      fcfHealth: "Cashflow Sustainability & Dividend Coverage",
    ...
    disclaimer: {
      prefix: "Integrated Fuente Methodology:",
    ...
    agenda: {
      ...
      alertToast: "Ex-Date reminders enabled successfully for monitored assets!",
      marketBr: "Brazil (B3)",
      marketUs: "United States (NYSE / Nasdaq)",
      eventsBadge: "{{count}} events",
      todayAnchor: "Go to Today ({{date}})",
      stats: {
        monitoredMonth: "Monitored {{month}} {{market}}",
        monitoredSub: "Audited announcements from CVM/SEC",
        comDates: "📌 Ex-Dates this Month",
        ...
        eventsUnit: "events",
        assetsUnit: "stocks/FIIs",
        depositsUnit: "deposits",
        opportunitiesUnit: "opportunities",
        safeAssetsUnit: "safe assets",
      },
      classes: {
        allBr: "All Classes",
        allUs: "All Asset Classes",
        stocksBr: "Stocks (B3)",
        fiis: "Real Estate (FIIs)",
        etfsBr: "ETFs B3",
        bdrs: "BDRs",
      ...
      eventTypes: {
        all: "All Events",
        com: "📌 Ex-Date Only (Eligibility)",
        pay: "💰 Payment Only (Cashflow)",
      },
      ...
      searchPlaceholder: "Filter by ticker or company name...",
      todayBadge: "Today ⚡",
      eventsScheduledSingle: "1 scheduled event",
      eventsScheduledPlural: "{{count}} scheduled events",
      badgeCom: "📌 Ex-Date",
      badgePay: "💰 Payment",
      taxTypes: {
        dividendo: "Exempt Dividend",
        jcp: "JCP (17.5% Tax Withheld)",
        rendimento_fii: "FII Distribution (Tax-Exempt)",
        us_cash: "US Cash Div (30% W-8BEN)",
        bdr: "BDR Distribution",
        amortizacao: "Special Distribution / Amortization",
      },
      reciprocalCom: "Payable on {{date}}",
      reciprocalPay: "Ex-Dividend date was {{date}}",
      belowCeiling: "🟢 Ceiling: {{price}} ({{margin}})",
      aboveCeiling: "⚠️ Above Ceiling ({{margin}})",
  ...
  comingSoonScreen: {
    ...
    withdrawDesc: "The tax-optimized withdrawal engine (least-impact sale suggestions) is planned but not implemented yet.",
    newsTitle: "Portfolio Changes Not Tracked Yet",
    newsDesc: "A feed of what changed in your portfolio and watched assets is planned but not implemented yet.",
    auditTitle: "Audit Trail Not Built Yet",
    auditDesc: "A history of every calculation and decision made in the app is planned but not implemented yet.",
  },
  taxRealityScreen: {
    title: "Tax Reality",
    subtitle: "Consolidated view of net dividends and capital gains in the current year",
    exportBtn: "Export CSV",
    summary: {
      dividendsLabel: "Net Dividends Received",
      dividendsHelper: "Sum of dividends, JCP, and US distributions (net of withholding)",
      stockCgLabel: "Capital Gains — Stocks",
      stockCgHelper: "Tax due on gains from stock sales (exempt up to R$ 20k/month)",
      fiiCgLabel: "Capital Gains — FIIs & FIAGROs",
      ...
      foreignCgLabel: "Capital Gains — Foreign Assets",
      foreignCgHelper: "15% flat on net annual gain from US stocks/REITs, no exemption (Law 14.754/2023)",
      etfFixedIncomeCgLabel: "Capital Gains — Fixed Income ETFs",
      etfFixedIncomeCgHelper: "Regressive table (22.5%→15% by holding period), no volume exemption (IN RFB 1.585/2015)",
      totalTaxLabel: "Total Estimated Tax",
      totalTaxHelper: "Sum of tax due on stocks, FIIs/FIAGROs, ETFs, foreign assets, and fixed income ETFs for the year (carryforwards never summed across tracks)",
    },
    monthlyDetail: {
      stocksTitle: "Monthly Detail — Stocks",
      fiisTitle: "Monthly Detail — FIIs & FIAGROs",
      etfsTitle: "Monthly Detail — Equity ETFs",
      etfFixedIncomeTitle: "Monthly Detail — Fixed Income ETFs",
      etfFixedIncomeNote: "Each sale is taxed at the rate matching how long that specific lot (FIFO) was held — 22.5% up to 180 days, 20% up to 360, 17.5% up to 720, 15% beyond.",
      foreignTitle: "Annual Detail — Foreign Stocks & REITs",
      yearHeader: "Year",
      monthHeader: "Month",
      salesHeader: "Sales (R$)",
      gainHeader: "Gain/Loss",
      exemptHeader: "Exempt",
      taxableGainHeader: "Taxable Gain",
      taxDueHeader: "Tax Due",
      carryforwardHeader: "Loss Carryforward",
      noData: "No sales this year",
    },
    unclassified: {
      title: "Unclassified Assets",
      description:
        "The assets below were not included in any tax calculation because their type could not be resolved. Configure each asset's type to ensure correct tax assessment.",
      ctaConfigure: "Configure asset types",
      empty: "All assets are correctly classified.",
    },
    limitsDeclared: {
      title: "Declared Limits — What this screen does NOT cover",
      items: [
        "Day-trade: distinct taxation (20% on net gain), not calculated here.",
        "Offshore funds and controlled entities abroad: not covered by the foreign capital gains calculation — consult your accountant (Law 14.754/2023). Foreign-listed ETFs (e.g. QQQ, SCHD) are already included alongside foreign stocks/REITs.",
        "Fixed Income ETFs (LFTS11, IMAB11, B5P211, etc.) are only calculated when explicitly marked as such in Settings — otherwise every ETF defaults to the equity rule (15% flat). Mark yours to enable the regressive-table calculation.",
        "Closed or concentrated FIIs (>25% / <50 unitholders): specific legal exceptions not handled.",
        "This is an illustrative simulation based on the data you registered. Tax rules have exceptions and change. Confirm with your accountant before filing.",
      ],
    },
    featureGateBlockedTitle: "Tax Reality Screen Locked",
    featureGateBlockedDesc: "The Tax Reality screen is temporarily unavailable.",
    loading: "Loading tax reality...",
    emptyStateTitle: "No sales in current year",
    emptyStateDesc: "No sell transactions recorded in the current calendar year. Capital gains will be assessed when sales occur.",
    hero: {
      darfLabel: "Estimated monthly tax due",
      withinExemption: "Within exemption",
      aboveExemption: "Above exemption",
      gaugeLabel: "Stock sales this month vs. the R$ 20,000 exemption",
      soldLabel: "{{value}} sold",
      remainingLabel: "{{value}} remaining",
      exceededLabel: "{{value}} over the limit",
    },
    breakdown: {
      lossCarryforward: "Accumulated loss",
      lossCarryforwardNote: "to offset",
      usWithholding: "US withholding tax",
      usWithholdingNote: "30% final",
      jcp: "JCP",
      jcpNote: "17.5% at source",
      brDividends: "BR dividends + FIIs",
      brDividendsNote: "tax-exempt",
    },
    grossNetTable: {
      title: "Gross × real net",
      pill: "everyone shows the gross",
      assetHeader: "Asset",
      grossHeader: "Gross received",
      netHeader: "Net received",
      lossHeader: "Loss",
    },
    tabs: {
      irpfMirror: "IRPF Mirror (Copy)",
      darfSales: "DARF & Sales",
      us1099: "IRS Form 1099",
      brSectionToggle: "Need Brazilian Tax Declaration (IRPF / DARF)?",
      hideBrSectionToggle: "Brazilian tax declaration (B3) is currently visible.",
      showBrTabsBtn: "Show B3 Tabs",
      hideBrTabsBtn: "Hide B3 Tabs",
      usTaxTitle: "US Tax Reporting & Form 1099",
      usTaxSubtitle: "Consolidated view of dividend income (1099-DIV), capital gains (1099-B / Schedule D) and tax-advantaged accounts",
    },
  },
  irpfMirror: {
    badge: "ANNUAL ADJUSTMENT DECLARATION (IRPF {{nextYear}} / CALENDAR YEAR {{baseYear}})",
    title: "IRPF Tax Mirror (Ready to Copy)",
    subtitle: "Standardized descriptions according to Brazilian Federal Revenue (RFB) layout. Copy and paste directly into the Annual Declaration Program (PGD) or e-CAC without typing errors.",
    legalComplianceNote: "Notice: Fiscal descriptions, group codes, and asset declarations are generated exclusively in Portuguese to comply with Brazilian Federal Revenue (Receita Federal do Brasil) official e-CAC / PGD tax declaration requirements.",
    exportAllBtn: "Export All (.txt)",
    exportSuccess: "IRPF report exported successfully!",
    copySuccess: "Description copied: {{label}}",
    copyError: "Could not copy to clipboard.",
    copiedBadge: "Copied!",
    copyBtn: "Copy",
    copyDiscriminationBtn: "Copy Description",
    field13Label: "Field 13 Description (IRPF Declaration):",
    statusPriorYear: "Status on 12/31/{{year}}:",
    statusCurrentYear: "Status on 12/31/{{year}}:",
    groupLabel: "Group:",
    codeLabel: "Code:",
    tabs: {
      assets: "Assets & Rights",
      exempt: "Exempt Income",
      exclusive: "Exclusive / JCP",
    },
    emptyAssets: "No active assets or positions in portfolio for this calendar year.",
    exemptCard: {
      title: "Tax-Exempt and Non-Taxable Income (Code 09 - Profits and Dividends)",
      desc: "Amounts received as dividends from Brazilian stocks and FII distributions during calendar year {{year}}.",
      codeLabel: "Code 09 • Profits and Dividends",
      declarableValue: "Declarable Amount:",
      empty: "No exempt dividends assessed in this period.",
    },
    exclusiveCard: {
      title: "Income Subject to Exclusive/Definitive Taxation (Code 10 - JCP)",
      desc: "Interest on Equity (JCP) with 17.5% income tax already withheld at source (Law 15.270/2025). In the IRPF, declare the net received amount.",
      codeLabel: "Code 10 • Interest on Equity (JCP)",
      netReceived: "Net Received:",
      withheldTax: "Withheld Tax (17.5%):",
      empty: "No JCP assessed in this period.",
    },
  },
  usTax1099: {
    badge: "US TAX RETURN (IRS FORM 1040 / 1099 SIMULATOR)",
    title: "IRS Form 1099 Simulator",
    subtitle: "Consolidated tax reporting for US tax residents. Segregation of Qualified Dividends, capital gains (FIFO), Wash Sale rules (IRC § 1091), and tax-sheltered Roth IRA tracking.",
    yearLabel: "Tax Year:",
    filterAccountLabel: "Account:",
    allAccounts: "All Accounts",
    taxableAccount: "Taxable Brokerage",
    rothIraAccount: "Roth IRA (Tax-Free)",
    traditionalIraAccount: "Traditional IRA / 401(k)",
    tabs: {
      div: "Form 1099-DIV (Dividends)",
      b: "Form 1099-B (Gains & Sales)",
      roth: "Roth IRA Shield",
    },
    metrics: {
      box1a: "Total Ordinary Dividends",
      box1aLabel: "Box 1a • Gross Distributions",
      box1b: "Qualified Dividends",
      box1bLabel: "Box 1b • Preferential Rate (0-20%)",
      box5: "Section 199A Dividends",
      box5Label: "Box 5 • REITs (Up to 20% QBI Deduction)",
      shortTermNet: "Net Short-Term Gain/Loss",
      shortTermLabel: "≤ 365 days • Ordinary Income Rate",
      longTermNet: "Net Long-Term Gain/Loss",
      longTermLabel: "> 365 days • Preferential Capital Gains Rate",
      washSaleDisallowed: "Wash Sale Disallowed",
      washSaleLabel: "Box 1g • IRC § 1091",
      rothShielded: "Roth IRA Shielded Income",
      rothShieldedLabel: "100% Tax-Free",
      qbiDeduction: "20% QBI Deduction:",
    },
    tableDiv: {
      ticker: "Ticker",
      payer: "Payer / Security",
      account: "Account",
      ordinary: "Box 1a (Ordinary)",
      qualified: "Box 1b (Qualified)",
      section199a: "Box 5 (Sec 199A REIT)",
      events: "Payments",
      copySummary: "Copy Form 1099 Summary",
      copySuccess: "Form 1099 tax summary copied to clipboard!",
      copyError: "Error copying to clipboard",
      badgeTaxable: "Taxable",
      badgeRoth: "Roth IRA",
      badgeTraditional: "401(k) / IRA",
      empty: "No dividend distributions found for the selected tax year.",
    },
    tableB: {
      ticker: "Security",
      account: "Account",
      ...
      costBasis: "Box 1e (Cost Basis)",
      washDisallowed: "Box 1g (Wash Disallowed)",
      gainLoss: "Gain / Loss",
      term: "Term",
      shortTerm: "Short-Term",
      longTerm: "Long-Term",
      washSaleBadge: "Wash Sale",
      empty: "No security sales found for the selected tax year.",
    },
    rothCard: {
      title: "Tax Advantage & Shielded Growth in Roth IRA",
      description: "Inside a Roth IRA account, all dividends received and capital gains realized grow 100% tax-free under IRS regulations, requiring no annual tax payments or 1099 filings.",
      shieldedDividends: "Shielded Dividends:",
      shieldedGains: "Shielded Capital Gains:",
      totalShielded: "Total Shielded Income:",
      estimatedSavings: "Estimated Tax Savings:",
      savingsNote: "Estimated based on an average 15% rate on qualified dividends and capital gains.",
    },
    exportBtn: "Export Form 1099 (.csv)",
    exportScheduleDBtn: "Export Schedule D / Form 8949 (.csv)",
    exportScheduleBBtn: "Export Schedule B (.csv)",
    exportSuccess: "Form 1099 report exported successfully!",
    exportScheduleDSuccess: "Schedule D / Form 8949 CSV exported successfully!",
    exportScheduleBSuccess: "Schedule B CSV exported successfully!",
  },
  askCsv: {
    colTicker: "Ticker",
    colOperation: "Operation",
    colQuantity: "Quantity",
    colRefPrice: "Reference Price (not a buy order)",
    colAmount: "Estimated Amount",
    colPercent: "Percentage",
    colReason: "Calculation Reason",
    colDate: "Generation Date",
    colStrategy: "Strategy Used",
    buyOperation: "Buy",
  },
  withdrawCsv: {
    colTax: "Estimated Tax",
    sellOperation: "Sell",
  },
  auditScreen: {
    ...
    totalTaxLabel: "Taxes paid",
    tableTitle: "Your decisions, revisited",
    tablePill: "learning, not judgment",
    emptyTitle: "No decision logged yet",
    emptyDesc: "As soon as you confirm a buy or sell, it shows up here — with the consensus at the time and the real tax paid.",
    emptyCta: "Add an asset →",
    dateHeader: "Date",
    assetHeader: "Asset",
    operationHeader: "Operation",
    priceHeader: "Price",
    consensusHeader: "Consensus at the time",
    consensusInline: "consensus",
    verdictHeader: "Verdict",
    effectHeader: "Effect",
    feesHeader: "Fee",
    taxHeader: "Tax",
    feesTaxHeader: "Fee/Tax",
    taxInline: "tax",
    totalHeader: "Total",
    buyLabel: "Buy",
    sellLabel: "Sell",
    verdicts: {
      ...
      yield_trap: "Yield trap",
      great_entry: "Great entry",
      fair_entry: "Fair entry",
      no_data: "No historical data",
      realized_gain: "Realized gain",
      realized_loss: "Realized loss",
      neutral: "Neutral",
    },
    featureGateBlockedTitle: "Audit Locked",
    featureGateBlockedDesc: "The audit trail is currently undergoing maintenance.",
  },
  transactionsLedger: {
    pageTitle: "Transaction Ledger",
    pageSubtitle: "Comprehensive accounting audit, executed order history, and corporate actions across all assets.",
    registerBtn: "Record Transaction",
    exportBtn: "Export CSV",
    kpis: {
      totalBuys: "Total Invested (Buys)",
      buysCount: "{{count}} buy orders",
      totalSells: "Total Disinvested (Sells)",
      sellsCount: "{{count}} sell orders",
      netFlow: "Net Cash Flow",
      netFlowSub: "Net new capital added",
      totalFees: "Fees & Brokerage",
      feesSub: "Deducted from average cost",
    },
    filters: {
      searchPlaceholder: "Search by ticker (BBAS3, AAPL), broker or notes...",
      all: "All",
      buys: "Buys",
      sells: "Sells",
    ...
    batch: {
      selectedCount: "{{count}} transaction selected",
      selectedCountPlural: "{{count}} transactions selected",
      editSelected: "Edit Selected",
      deleteSelected: "Delete Selected",
      cancel: "Cancel",
      confirmBatchDelete: "Are you sure you want to delete {{count}} selected transactions? The average price of affected assets will be recalculated automatically.",
      selectAllFiltered: "Select all {{count}} filtered transactions",
      allFilteredSelected: "All {{count}} filtered transactions are selected.",
    ...
    table: {
      ...
      thesis: "Fuente Thesis",
      actions: "Actions",
      viewThesis: "View Thesis",
      noThesis: "—",
      edit: "Edit",
      delete: "Delete",
      confirmDelete: "Are you sure you want to delete this transaction? Average price will be recalculated.",
      buyBadge: "BUY",
      sellBadge: "SELL",
      splitBadge: "SPLIT",
      emptyTitle: "No transactions found",
      emptyDesc: "No transactions match your current filter criteria.",
      showingCount: "Showing {{shown}} of {{total}} transactions",
      previousPage: "Previous",
      nextPage: "Next",
    },
    thesisModal: {
      title: "Buy Thesis — {{ticker}}",
      subtitle: "Immutable snapshot of Fuente criteria captured when this order was executed:",
      purchasePrice: "Purchase Price Paid",
      ceilingPrice: "Fuente Ceiling Price (Consensus)",
      safetyMargin: "Safety Margin on Date",
      piotroskiScore: "Piotroski F-Score",
      close: "Close",
    },
    newModal: {
      createTitle: "Record New Transaction",
      editTitle: "Edit Transaction — {{ticker}}",
      createSubtitle: "Add a buy, sell, or split transaction directly to your portfolio.",
      operationType: "Operation Type",
      buy: "Buy (Contribution)",
      sell: "Sell (Disinvestment)",
      corporateAction: "Stock Split / Grouping",
      ticker: "Asset (Ticker)",
      tickerPlaceholder: "e.g. BBAS3, AAPL",
      date: "Date",
      quantity: "Quantity",
      price: "Unit Price",
      broker: "Broker",
      brokerPlaceholder: "e.g. BTG, XP, Avenue, Schwab",
      accountType: "Account Type",
      accountTypeTaxable: "Taxable (Individual / Joint)",
      accountTypeRoth: "Roth IRA (Tax-Free)",
      accountTypeTraditional: "Traditional IRA / 401(k)",
      fees: "Fees & Brokerage",
      factor: "Factor (Ratio)",
      notes: "Notes / Reasoning",
      notesPlaceholder: "Optional...",
      thesisNotice: "Automatic Thesis Capture: When saving a buy order, the system captures the Fuente Ceiling Price and Safety Margin for future audit.",
      cancel: "Cancel",
      save: "Save Transaction",
      saving: "Saving...",
      successCreate: "Transaction for {{ticker}} recorded successfully!",
      successEdit: "Transaction for {{ticker}} updated successfully!",
      successDelete: "Transaction deleted and position recalculated!",
      successBatchDelete: "{{count}} transactions deleted successfully!",
      invalidTicker: "Please enter a valid ticker.",
      invalidQuantity: "Please enter a valid positive quantity.",
      invalidPrice: "Please enter a valid unit price.",
    },
    bulkModal: {
      title: "Bulk Edit Transactions",
      description: "Update the desired fields for the {{count}} selected transactions at once.",
      affectedAssets: "Affected assets:",
      changeBroker: "Change Broker",
      brokerPlaceholder: "e.g.: BTG Pactual, Schwab, Fidelity...",
      clearBrokerOption: "Leave blank (remove broker)",
      changeDate: "Change Trade Date",
      changeNotes: "Update Notes",
      notesPlaceholder: "Joint note for all selected transactions...",
      saveChanges: "Apply to {{count}} transactions",
      saving: "Applying changes...",
      success: "{{count}} transactions updated successfully!",
      noChangesSelected: "Select at least one field to change.",
      recalculateThesis: "Generate / Update Fuente Thesis for buys",
      recalculateThesisDesc: "Calculates and freezes the Fuente Consensus Ceiling Price and Margin of Safety on selected buy orders based on portfolio fundamentals.",
      missingThesisBadge: "{{count}} missing thesis",
      noticeRecalculation: "Average price and balance for affected assets will be recalculated automatically if dates change.",
    },
  },
  dgi: {
  ...
  taxLots: {
    title: "Tax Lots Monitor (IRS FIFO)",
    subtitle: "Tracking open lots, holding periods, and capital gains status",
    shortTerm: "Short-Term",
    longTerm: "Long-Term",
    shortTermBadge: "Short-Term (≤ 365d)",
    longTermBadge: "Long-Term (> 365d)",
    shortTermRateHint: "Taxed at ordinary income rates",
    longTermRateHint: "Eligible for 0% / 15% / 20% LTCG rate",
    holdingProgress: "Holding Period Breakdown",
    daysHeld: "{{count}}d held",
    daysUntilLongTerm: "{{count}}d to Long-Term",
    longTermQualified: "Qualified for LTCG",
    lotDate: "Acquisition Date",
    shares: "Shares",
  ...
  newsScreen: {
    metaTitle: "What Changed | Fuente Price Pro",
    eyebrowPrefix: "Since your last visit ·",
    eyebrowToday: "Today",
    eyebrowDaysAgo: "{{days}} days ago",
    eyebrowDayAgo: "1 day ago",
    title: "What changed",
    receiveByEmail: "Receive by email every Monday",
    kpis: {
      attentionRequired: "Require attention",
      attentionSub: "thesis may have shifted",
      enteredBuyZone: "Entered buy zone",
      enteredBuyZoneSub: "below ceiling price",
      announcedDividends: "Announced dividends",
      announcedCount: "{{count}} announcements",
      announcedCountSingle: "1 announcement",
      netWorthChange: "Net worth",
      inTheWeek: "in the week",
    },
    feed: {
      sectionTitle: "Changes that demand your attention",
      byImpactPill: "by impact",
      emptyTitle: "Everything looks steady",
      emptyDesc: "No critical changes detected in your portfolio since your last visit. As assets announce payouts or cross ceiling thresholds, alerts will appear here.",
      actions: {
        viewIncomeImpact: "See impact on your income →",
        compareThesis: "Compare original thesis vs. today →",
        addToNextContribution: "Include in next contribution →",
        viewGuaranteedIncome: "View guaranteed income →",
      },
      timeAgo: {
        today: "today",
        yesterday: "yesterday",
      ...
      templates: {
        dividendCutTitle: "{{ticker}} cut distribution by {{percent}}%",
        dividendCutDesc: "Distribution dropped from {{from}} to {{to}} per share. Previous yield was supported by non-recurring gains — yield trap confirmed.",
        yieldTrapTitle: "Yield trap signal on {{ticker}}",
        yieldTrapDesc: "Current yield of {{currentYield}}% is more than 2x its 5-year average ({{historicalYield}}%). Substantial risk of payout cut.",
        thesisDriftTitle: "{{ticker}} is no longer the asset you bought",
        thesisDriftPayoutDesc: "Payout ratio rose from {{from}}% to {{to}}% since purchase. The company distributes almost all earnings — leaving little room for dividend growth.",
        thesisDriftGenericDesc: "Current fundamentals have drifted significantly from the purchase thesis captured at transaction time.",
        buyZoneTitle: "{{ticker}} entered your buy zone",
        buyZoneDesc: "Current price at {{price}}, now {{margin}}% below consensus ceiling — attractive margin of safety in your watched assets.",
        dividendAnnouncedTitle: "{{ticker}} announced upcoming dividends",
        dividendAnnouncedDesc: "Dividend of {{amount}} announced, scheduled for payment on {{date}} (in {{days}} days).",
      },
    },
    digestModal: {
      title: "Email Notification Settings",
      description: "Customize when and which portfolio updates you want delivered to your inbox.",
      emailLabel: "Delivery email",
      masterToggleLabel: "Enable portfolio email summaries",
      masterToggleDesc: "Receive email updates based on your chosen frequency and selected topics.",
      subscribedAlert: "Email summaries currently active.",
      unsubscribedAlert: "Enable to receive portfolio summaries by email.",
      frequencySectionTitle: "Delivery frequency",
      frequencies: {
        weekly: "Weekly",
        weeklyDesc: "Executive summary every week",
        monthly: "Monthly",
        monthlyDesc: "Consolidated for contribution day",
        criticalOnly: "Critical Only",
        criticalOnlyDesc: "Only yield traps & dividend cuts",
      },
      timingSectionTitle: "Delivery day and time",
      daysOfWeek: {
        monday: "Monday (morning)",
        friday: "Friday (closing)",
      },
      daysOfMonth: {
        firstBusinessDay: "1st business day (salary/contribution)",
        firstDay: "1st day of the month",
        fifteenth: "15th day of the month",
      },
      topicsSectionTitle: "What to include in the report",
      topics: {
        income: "Announced payouts and payment schedule",
        risk: "Dividend cuts and yield trap alerts",
        thesis: "Purchase thesis shifts and high payout warnings",
        opportunities: "Assets entering the buy zone below ceiling",
      },
      buttons: {
        default: "Receive by email",
        subscribedWeeklyMonday: "Weekly digest · Mondays",
        subscribedWeeklyFriday: "Weekly digest · Fridays",
        subscribedMonthlyFirstBusiness: "Monthly digest · 1st business day",
        subscribedMonthlyFirst: "Monthly digest · 1st of month",
        subscribedMonthlyFifteenth: "Monthly digest · 15th of month",
        subscribedCritical: "Critical alerts by email",
        subscribedGeneric: "Email digest active",
      },
      lgpdNotice: "We respect your privacy (LGPD/GDPR). You can update preferences or disable emails at any time on this screen or in Settings > Privacy.",
      saveBtn: "Save preferences",
      cancelBtn: "Cancel",
      loginRequired: "Please sign in to enable email notifications.",
    },
  },
};
