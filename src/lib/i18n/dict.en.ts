  ...
  taxRealityScreen: {
    ...
    limitsDeclared: {
      ...
      items: [
        ...
        "Foreign assets (STOCK_US, REIT): capital gains follow separate rules, not included.",
        "Fixed Income ETFs: follow regressive fixed income tax table (IN RFB 1.585/2015), not calculated here. This screen calculates only equity ETFs (15% flat without sales volume exemption).",
