...
export const es = {
  ...
  dividendRadar: {
    ...
    disclaimer: {
      ...
      body: "Combina el Margen de Seguridad Bazin (DPA / 6% u 8%), el Dividend Safety Score™ (0-100) y la Estacionalidad de los últimos 5 años auditada en CVM y SEC. El DY Neto Real deduce retenciones en la fuente (30% en EE.UU. vía W-8BEN y 15% en Brasil vía JCP). Consulte siempre los informes oficiales de cada emisor.",
    },
