...
export const es = {
  ...
  newsScreen: {
    ...
    digestModal: {
      ...
      description: "Reciba cada lunes por la mañana un resumen ejecutivo con dividendos anunciados, cambios de tesis y oportunidades en su cartera.",
      emailLabel: "Correo de destino",
      subscribedAlert: "Actualmente está suscrito para recibir el resumen semanal cada lunes.",
      unsubscribedAlert: "Active para recibir el resumen de cambios en su cartera semanalmente.",
      lgpdNotice: "Respetamos su privacidad (LGPD/GDPR). Puede cancelar la suscripción en cualquier momento en esta pantalla o en Configuración > Privacidad.",
      enableBtn: "Activar resumen semanal",
      disableBtn: "Desactivar resumen",
      closeBtn: "Cerrar",
      loginRequired: "Inicie sesión con su cuenta para activar los resúmenes por correo.",
    },
  },
} satisfies typeof en;
