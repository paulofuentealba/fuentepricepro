...
export const es = {
  ...
  explore: {
    ...
    descriptions: {
      ...
      dividendRadar: "Escáner predictivo y estacionalidad de dividendos con Score 360° de sostenibilidad, precio techo Bazin y cobertura de caja.",
  ...
  deepDive: {
    ...
    taxPassports: {
      ...
      usForeignBr: "<strong>Activo Extranjero (B3 - Brasil):</strong> Los rendimientos se reportan como ingresos extranjeros en el IRS Form 1040. Si se aplica retención en Brasil (ej. JCP 17,5%), se puede reclamar el Foreign Tax Credit (IRS Form 1116).<br><strong>Ganancia de Capital:</strong> Tributa según las reglas generales de ganancias de capital de EE. UU.",
      brStock: "<strong>Rendimientos:</strong> Los dividendos están exentos de IRPF para personas físicas en Brasil (con retención del 10% únicamente sobre importes superiores a R$ 50 mil/mes de la misma empresa, según Ley 15.270/2025). El JCP sufre retención exclusiva y definitiva del 17,5% en la fuente (Ley 15.270/2025 / LC 224/2025).<br><strong>Ganancia de Capital:</strong> Ventas al contado hasta R$ 20.000/mes están exentas. Por encima de este límite, tasa del 15% sobre el beneficio neto (20% en day trade).",
      ...
      questions: {
        ...
        items: [
          ...
          },
          {
            ...
            desc: "30% retenido en EE.UU., JCP al 17,5%, FII exento. El yield bruto es ficción — mostramos el neto real.",
          },
          {
  ...
  dashboard: {
    ...
    taxRegime: {
      ...
      exemptStockBr: "Exento (Dividendos) / 17,5% (JCP)",
      whtCompensable: "WHT 30% Compensable",
      jcpWithholding: "IR 17,5% en la Fuente (JCP)",
  ...
  valuationAssumptions: {
    ...
    bazinTooltipNetJcp: "JCP neto (retención 17,5% IR en la fuente ya descontada)",
  ...
  dividendRadar: {
    title: "Radar 360° de Dividendos y Calendario Táctico",
    eyebrow: "Fusión Institucional · Safety Score 360° + Margen Bazin + Calendario Estacional Ene-Dic",
    marketsBadge: "★ Mercados: B3 + NYSE / Nasdaq",
    viewMode: {
      cards: "Modo Tarjetas",
      table: "Modo Tabla Pro",
    },
    gapFinder: {
      title: "Gap Finder — Cobertura de Meses Secos y Dividend Safety",
      descriptionWithGaps: "Su cartera actualmente recibe menos de {{amount}} en los meses de {{months}}. Filtre los meses abajo para descubrir activos con Dividend Safety Score > 80 y consistencia histórica por debajo del Precio Techo Bazin.",
      descriptionNoGaps: "Identifique oportunidades tácticas en los meses de mayor densidad de dividendos en B3 y mercado global (Mayo y Noviembre). Activos con alta consistencia histórica y margen de seguridad positivo.",
      ctaFill: "⚡ Llenar Mes de {{month}}",
      radarCount: "{{count}} activos",
      radarCountSub: "en el radar táctico",
    },
    seasonality: {
      title: "Línea de Tiempo de Anuncios Previstos (Haga clic en el mes para filtrar el flujo):",
      statusAll: "Mostrando: Todos los meses ({{count}} activos monitoreados)",
      statusMonth: "Mostrando: Mes de {{month}} ({{count}} activos con ventana histórica prevista)",
      allMonths: "TODOS",
    ...
    strategies: {
      all: "🌐 Todas las Tesis",
      dgi: "💎 Reyes de Dividendos",
      bazin: "🟢 Oportunidades < Techo",
      monthly: "🗓 Pagos Mensuales",
      risk: "⚠️ Alertas de Riesgo",
    },
    searchPlaceholder: "Filtrar por ticker o nombre...",
    card: {
      price: "Cotización",
      ceiling: "Precio Techo",
      margin: "Margen",
      ...
      investBtn: "+ Aportar",
      auditBtn: "Auditar Riesgo",
      belowCeiling: "bajo el techo",
      aboveCeiling: "sobre el techo",
      scoreSuffix: "/100",
    },
    table: {
      colAsset: "Activo",
      colPrice: "Cotización",
      colCeiling: "Precio Techo",
      colMargin: "Margem",
      colDyGross: "DY Bruto",
      colDyNet: "DY Neto Real (Bolsillo)",
      colPayout: "Payout FCF",
      colScore: "Safety Score",
      colNextMonth: "Mes Previsto (5a)",
      colWindowCom: "Próxima Fecha Com",
      colAction: "Acción",
    },
    detailSheet: {
      title: "Radiografía de Dividendos y Valuación",
      statusRadar: "Estado del Radar",
      bazinDecomposition: "Descomposición del Precio Techo Bazin",
      dpa: "Dividendo Promedio Proyectado (DPA)",
      targetYield: "Yield Objetivo Mínimo Requerido",
      formulaBazin: "Fórmula: DPA ÷ Yield Objetivo",
      currentPrice: "Cotización Actual de Mercado",
      effectiveMargin: "Margen de Seguridad Efectivo",
      fcfHealth: "Sostenibilidad de Caja y Cobertura de Dividendos",
    ...
    disclaimer: {
      prefix: "Metodología Integrada Fuente:",
    ...
    agenda: {
      ...
      alertToast: "¡Recordatorios de Fecha Ex activados con éxito para los activos monitoreados!",
      marketBr: "Brasil (B3)",
      marketUs: "Estados Unidos (NYSE / Nasdaq)",
      eventsBadge: "{{count}} eventos",
      todayAnchor: "Ir a Hoy ({{date}})",
      stats: {
        monitoredMonth: "Monitoreados {{month}} {{market}}",
        monitoredSub: "Anuncios auditados en CVM/SEC",
        comDates: "📌 Fechas Ex en el Mes",
        ...
        eventsUnit: "eventos",
        assetsUnit: "acciones/FIIs",
        depositsUnit: "depósitos",
        opportunitiesUnit: "oportunidades",
        safeAssetsUnit: "activos seguros",
      },
      classes: {
        allBr: "Todas las Clases",
        allUs: "All Asset Classes",
        stocksBr: "Acciones (B3)",
        fiis: "FIIs (Inmobiliarios)",
        etfsBr: "ETFs B3",
        bdrs: "BDRs",
      ...
      badgePay: "💰 Pago",
      taxTypes: {
        dividendo: "Dividendo Exento",
        jcp: "JCP (17,5% Retención)",
        rendimento_fii: "Rendimiento FII (Exento)",
        us_cash: "US Cash (30% W-8BEN)",
        bdr: "Dividendo BDR (Repercutido)",
        amortizacao: "Distribución Especial / Amortización",
      },
      reciprocalCom: "Pago previsto el {{date}}",
      reciprocalPay: "Fecha Ex fue el {{date}}",
      belowCeiling: "🟢 Techo: {{price}} ({{margin}})",
      aboveCeiling: "⚠️ Sobre Techo ({{margin}})",
  ...
  irpfMirror: {
    ...
    exclusiveCard: {
      ...
      desc: "Intereses sobre el Capital Propio (JCP) con retención de impuesto del 17,5% en origen (Ley 15.270/2025). En el IRPF, declare el monto neto recibido.",
      codeLabel: "Código 10 • Intereses sobre el Capital Propio",
      netReceived: "Neto Recibido:",
      withheldTax: "Impuesto Retenido (17,5%):",
