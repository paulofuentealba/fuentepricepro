...
export const es = {
  ...
  dashboard: {
    kpi: {
      ...
      availableContributionSub: "Configurado en Metas",
    },
    fire: {
    ...
    matrix: {
      ...
      columnCeiling: "Precio Techo Fuente",
      columnMargin: "Margen de Seguridad",
      columnNetDy: "DY Neto (12M)",
      columnTaxRegime: "Régimen Tributario",
      columnAction: "Acción Recomendada",
      actionBuy: "Comprar",
      actionWatch: "Observar",
      actionAvoid: "Estirado / Evitar",
