  ...
  taxRealityScreen: {
    ...
    limitsDeclared: {
      ...
      items: [
        ...
        "Acciones y activos en el exterior (STOCK_US, REIT): ganancia de capital sigue regla propia, no incluida.",
        "ETFs de Renta Fija: siguen la tabla regresiva de renta fija (IN RFB 1.585/2015), no calculados aquí. Esta pantalla calcula solo ETFs de renta variable (15% flat sin exención de volumen).",
