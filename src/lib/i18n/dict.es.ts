...
export const es = {
  ...
  taxRealityScreen: {
    ...
    summary: {
      ...
      fiiCgLabel: "Ganancia de Capital — FIIs",
      fiiCgHelper: "Impuesto debido sobre ganancias en ventas de FIIs (20% sin exención de volumen)",
      totalTaxLabel: "Impuesto Total Estimado",
      totalTaxHelper: "Suma del impuesto debido en acciones y FIIs en el año (carryforwards no sumados entre sí)",
    },
    monthlyDetail: {
      stocksTitle: "Detalle Mes a Mes — Acciones",
      fiisTitle: "Detalle Mes a Mes — FIIs",
      monthHeader: "Mes",
    ...
    limitsDeclared: {
      ...
      items: [
        ...
        "Acciones en el exterior (STOCK_US, REIT, ETF): ganancia de capital sigue regla propia (15% con compensación), no incluida.",
        "ETFs de acciones (ambigüedad): tratamiento como acción o fondo aún pendiente de definición jurídica consolidada.",
        "FIIs cerrados o concentrados (>25% / <50 cotistas): excepción de exención de ganancia de capital no tratada.",
        "FIAGRO y FII_INFRA: equiparación al régimen de FII (Ley 14.130/2021 y Ley 12.431/2011) pendiente de revisión jurídica expresa.",
