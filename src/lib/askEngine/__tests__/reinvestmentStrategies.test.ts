    ...
    it("ranks positions strictly by net dividendYield from SSOT (not gross recalculation)", () => {
      ...
      const posBR = createMockPosition({
        ...
        valuation: {
          ...
          margin: 33.3,
          fuenteConsensus: 40,
          methods: { bazin: 40, graham: null, gordon: null, lynch: null },
          assumptions: [],
          investorProfile: "moderate",
          bazin: 40,
          graham: null,
      ...
      const posUS = createMockPosition({
        ...
        valuation: {
          ...
          margin: 20,
          fuenteConsensus: 60,
          methods: { bazin: 60, graham: null, gordon: null, lynch: null },
          assumptions: [],
          investorProfile: "moderate",
          bazin: 60,
          graham: null,
    ...
    it("resists fractional shares and respects remaining budget cap", () => {
      const pos = createMockPosition({
        ...
        valuation: {
          ...
          margin: 28.5,
          fuenteConsensus: 90,
          methods: { bazin: 90, graham: null, gordon: null, lynch: null },
          assumptions: [],
          investorProfile: "moderate",
          bazin: 90,
          graham: null,
    ...
    it("does NOT perform silent fallback when sourceTicker is excluded by criteria (e.g. above ceiling)", () => {
      const posPayerAboveCeiling = createMockPosition({
        ...
        valuation: {
          ...
          margin: -12.5,
          fuenteConsensus: 35,
          methods: { bazin: 35, graham: null, gordon: null, lynch: null },
          assumptions: [],
          investorProfile: "moderate",
          bazin: 35,
          graham: null,
