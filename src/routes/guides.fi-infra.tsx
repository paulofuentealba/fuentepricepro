...
const PAGE_URL = `${SITE_URL}/guides/fi-infra`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/fi-infra")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.fiInfra;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "FI-Infraestrutura", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="fi-infra" />,
