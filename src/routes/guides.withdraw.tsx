...
const PAGE_URL = `${SITE_URL}/guides/withdraw`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/withdraw")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.withdraw;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Desinvestimento Fiscal", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="withdraw" />,
