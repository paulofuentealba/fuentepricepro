...
const PAGE_URL = `${SITE_URL}/guides/tax-usa`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/tax-usa")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.taxUsa;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Tributação EUA", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="tax-usa" />,
