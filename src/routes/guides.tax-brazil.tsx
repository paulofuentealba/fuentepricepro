...
const PAGE_URL = `${SITE_URL}/guides/tax-brazil`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/tax-brazil")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.taxBrazil;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Tributação Brasil", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="tax-brazil" />,
