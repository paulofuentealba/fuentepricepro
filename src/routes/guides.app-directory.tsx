...
const PAGE_URL = `${SITE_URL}/guides/app-directory`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/app-directory")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.appDirectory;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Mapa do Aplicativo", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="app-directory" />,
