...
const PAGE_URL = `${SITE_URL}/guides/snowball`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/snowball")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.snowball;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Bola de Neve & FIRE", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="snowball" />,
