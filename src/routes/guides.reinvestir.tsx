...
const PAGE_URL = `${SITE_URL}/guides/reinvestir`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/reinvestir")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.reinvestir;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Reinvestir Proventos", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="reinvestir" />,
