...
import { Sparkles, Activity, ShieldCheck, Map, ArrowRight, LineChart, CalendarDays, TrendingUp } from "lucide-react";
...
// --- Custom Animated Number Hook Component ---
    ...
    <div className="dark min-h-screen bg-[#030712] text-slate-100 font-sans selection:bg-emerald-500/30 overflow-x-hidden flex flex-col relative">
      ...
      <section className="relative w-full flex flex-col items-center justify-start pt-20 pb-0 px-4 sm:px-6 lg:px-8 z-20 bg-[#030712]">
        ...
        >
          ...
          <div 
            className="relative w-full rounded-t-xl shadow-[0_-20px_50px_rgba(0,0,0,0.5)] [transform:rotateX(15deg)] [transform-origin:top_center]"
          >
            {/* The Strict Overflow Container */}
            <div className="relative w-full h-full overflow-hidden rounded-t-xl border-t border-l border-r border-white/10 bg-[#0a0a0a]/90 backdrop-blur-xl isolate" style={{ maskImage: "linear-gradient(to bottom, black 40%, transparent 100%)", WebkitMaskImage: "linear-gradient(to bottom, black 40%, transparent 100%)", transform: "translateZ(0)" }}>
              ...
              <div className="h-10 bg-white/5 border-b border-white/5 flex items-center px-4 gap-2">
                ...
                <div className="mx-auto bg-black/40 rounded px-24 py-1 text-[10px] text-slate-500 font-mono flex items-center gap-2">
                  <ShieldCheck className="w-3 h-3" /> fuentepricepro.app/app
                </div>
              </div>
                ...
                <div className="col-span-10 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="h-32 bg-white/5 rounded-xl border border-white/5 p-5 flex flex-col justify-center">
                      <p className="text-xs text-slate-400 mb-2 uppercase tracking-wider">Consolidated Equity</p>
                      <p className="text-2xl font-bold text-white tracking-tight"><AnimatedNumber value={1458290} prefix="R$ " decimals={0} delay={300} /></p>
                    ...
                    <div className="h-32 bg-white/5 rounded-xl border border-emerald-500/10 p-5 flex flex-col justify-center relative overflow-hidden">
                      ...
                      <p className="text-xs text-emerald-400/80 mb-2 uppercase tracking-wider relative z-10">Monthly Yield</p>
                      <p className="text-2xl font-bold text-white relative z-10"><AnimatedNumber value={1240.50} prefix="R$ " decimals={2} delay={450} /></p>
                    </div>
                    ...
                    <div className="h-32 bg-white/5 rounded-xl border border-blue-500/10 p-5 flex flex-col justify-center relative overflow-hidden">
                      ...
                      <p className="text-xs text-blue-400/80 mb-2 uppercase tracking-wider relative z-10">Total Dividends</p>
                      <p className="text-2xl font-bold text-white relative z-10"><AnimatedNumber value={84200} prefix="R$ " decimals={0} delay={600} /></p>
                    </div>
                  </div>
      ...
      <section id="features" className="relative z-10 py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full bg-[#030712]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative z-10 rounded-xl border border-white/10 bg-[#0a0a0a]/90 p-6 shadow-2xl w-full md:w-[400px]">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  <p className="text-[10px] text-emerald-400 font-mono border border-emerald-500/30 bg-emerald-500/10 px-2 py-1 rounded tracking-wide">{L.mockupBuySignal}</p>
                </div>
              </div>

              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center text-xs text-slate-300 border-b border-white/5 pb-2">
                  <span>Bazin</span><span className="font-mono"><AnimatedNumber value={32.40} prefix="R$ " decimals={2} delay={0} /></span>
                </div>
                <div className="flex justify-between items-center text-xs text-slate-300 border-b border-white/5 pb-2">
                  <span>Graham</span><span className="font-mono"><AnimatedNumber value={41.10} prefix="R$ " decimals={2} delay={150} /></span>
                </div>
                <div className="flex justify-between items-center text-xs text-slate-300 border-b border-white/5 pb-2">
                  <span>Gordon</span><span className="font-mono"><AnimatedNumber value={35.80} prefix="R$ " decimals={2} delay={300} /></span>
                </div>
              </div>
              ...
              >
                ...
                <p className="relative z-10 text-[10px] text-emerald-400 uppercase tracking-widest font-bold mb-1">{L.mockupConsensus}</p>
                <p className="relative z-10 text-3xl font-bold text-white tracking-tight"><AnimatedNumber value={36.43} prefix="R$ " decimals={2} delay={800} /></p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 overflow-hidden hover:border-yellow-500/30 transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="relative z-10 mb-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 leading-tight">{L.panel2Title}</h3>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 rounded border border-white/5 p-2 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-[8px] font-bold">US</div>
                    <div>
                ...
                <div className="bg-white/5 rounded border border-white/5 p-2 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-[8px] font-bold">BR</div>
                    <div>
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 overflow-hidden hover:border-pink-500/30 transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="relative z-10 mb-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 leading-tight">{L.panel3Title}</h3>
              <p className="text-sm text-slate-400 leading-relaxed">{L.panel3Sub}</p>
            </div>
            
            <div className="relative z-10 rounded-xl border border-white/10 bg-[#0a0a0a]/80 p-4 shadow-xl">
              <p className="text-[10px] text-slate-500 uppercase tracking-widest mb-3">{L.mockupUpcomingDividends}</p>
              ...
              <div className="flex items-end gap-2 h-20 mb-2 border-b border-white/10 pb-2">
                <div className="flex-1 bg-white/5 rounded-t-sm relative group/bar">
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 text-[8px] text-slate-500 mb-1">Jul</div>
                </div>
                <div className="flex-1 bg-pink-500/40 rounded-t-sm relative border-t border-pink-500" style={{ height: '80%' }}>
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 text-[8px] text-pink-400 mb-1">{L.mockupMonth}</div>
                </div>
                <div className="flex-1 bg-white/5 rounded-t-sm relative" style={{ height: '40%' }}>
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 text-[8px] text-slate-500 mb-1">Sep</div>
                </div>
                <div className="flex-1 bg-white/5 rounded-t-sm relative" style={{ height: '60%' }}>
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 text-[8px] text-slate-500 mb-1">Oct</div>
                </div>
              </div>
              <div className="text-center pt-1">
                <p className="text-lg font-bold text-white">R$ 1.240<span className="text-xs text-slate-500">,50</span></p>
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 overflow-hidden hover:border-cyan-500/30 transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="relative z-10 mb-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 leading-tight">{L.panel4Title}</h3>
            ...
            <div className="relative z-10 rounded-xl border border-white/10 bg-[#0a0a0a]/80 p-4 shadow-xl">
              <div className="flex items-center justify-between mb-4 border-b border-white/5 pb-4">
                <div className="flex gap-2 items-center">
                  <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 text-[10px] font-bold border border-blue-500/30">US$</div>
                  <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 text-[10px] font-bold border border-emerald-500/30 -ml-2">R$</div>
                </div>
              ...
              <div className="text-center py-2">
                <p className="text-[10px] text-slate-500 uppercase tracking-widest mb-1">{L.mockupNetWorth}</p>
                <p className="text-2xl font-bold text-white tracking-tight"><AnimatedNumber value={142850} prefix="R$ " decimals={2} delay={200} /></p>
              </div>
            </div>
          </div>
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 overflow-hidden hover:border-blue-500/30 transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="relative z-10 mb-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 leading-tight">{L.panel5Title}</h3>
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 overflow-hidden hover:border-purple-500/30 transition-all duration-500 flex flex-col justify-between">
            ...
            <div className="relative z-10 mb-6">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 leading-tight">{L.panel6Title}</h3>
            ...
            <div className="relative z-10 rounded-xl border border-white/10 bg-[#0a0a0a]/80 p-4 shadow-xl flex flex-col justify-between h-[156px]">
              ...
              <div className="absolute inset-0 p-4 opacity-40 pointer-events-none">
                <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                  <path d="M0,100 C40,95 70,70 100,0" fill="none" stroke="url(#purpleGradient2)" strokeWidth="3" strokeLinecap="round" className="animate-pulse" />
                  <defs>
              ...
              <div className="relative z-10">
                <p className="text-2xl font-bold text-white tracking-tight"><AnimatedNumber value={2035} decimals={0} delay={200} /></p>
                <p className="text-[10px] text-purple-400 font-mono mt-0.5">Crossover Point reached</p>
              </div>
      ...
      <footer className="border-t border-white/10 bg-[#030712]/40 backdrop-blur relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col items-center justify-center gap-4 text-sm text-slate-500">
          ...
          <div className="flex items-center gap-4 text-xs">
            <a href="#" className="hover:text-slate-300 transition-colors">{L.footerLegal1}</a>
            <span>|</span>
            <a href="#" className="hover:text-slate-300 transition-colors">{L.footerLegal2}</a>
            <span>|</span>
            <a href="#" className="hover:text-slate-300 transition-colors">{L.footerLegal3}</a>
          </div>
        </div>
      </footer>
    </div>
