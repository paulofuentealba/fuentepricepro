...
const PAGE_URL = `${SITE_URL}/guides/contribution-plan`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/contribution-plan")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.contributionPlan;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Plano de Aportes", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="contribution-plan" />,
