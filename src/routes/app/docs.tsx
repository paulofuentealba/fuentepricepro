...
import { BookOpen, Calculator, LineChart, Building, Lightbulb, Search, AlertCircle, Percent, ShieldCheck, Scale, Banknote, HelpCircle, AlertTriangle, TrendingUp } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-1 hidden md:block">
          <div className="sticky top-20 space-y-4">
            <h3 className="font-semibold text-sm uppercase tracking-wider text-muted-foreground mb-4">Índice</h3>
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          <div className="grid gap-6">
            ...
            {filterCard(t.docs.consensus.title, t.docs.consensus.description) && (
              <Card id="consensus" className="bg-background/60 backdrop-blur-md border-emerald-500/20 scroll-m-20">
                <CardHeader>
            ...
            {filterCard(t.docs.graham.title, t.docs.graham.description) && (
              <Card id="graham" className="bg-background/40 backdrop-blur-md scroll-m-20">
                <CardHeader className="flex flex-row items-center justify-between">
                  ...
                  <Badge variant="destructive" className="ml-2 font-medium bg-red-900/40 text-red-400 border-red-500/30">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-xs text-red-400/80">
                    * {t.docs.graham.notApplicableReason}
                  </p>
            ...
            {/* Metrics */}
            <h2 className="text-2xl font-bold tracking-tight mt-8 mb-4 border-b border-border pb-2">{t.docs.metrics.title}</h2>
            
            {filterCard(t.docs.metrics.safetyMargin.title, t.docs.metrics.safetyMargin.description) && (
            ...
            {filterCard(t.docs.metrics.yieldOnCost.title, t.docs.metrics.yieldOnCost.description) && (
            ...
            {/* Concepts */}
            <h2 className="text-2xl font-bold tracking-tight mt-8 mb-4 border-b border-border pb-2">{t.docs.concepts.title}</h2>
            ...
            {/* Risk Radar */}
            <h2 className="text-2xl font-bold tracking-tight mt-8 mb-4 border-b border-border pb-2">{t.docs.riskRadar.title}</h2>

            {filterCard(t.docs.riskRadar.sectorConcentration.title, t.docs.riskRadar.sectorConcentration.description) && (
              <Card id="sector-concentration" className="bg-background/40 backdrop-blur-md scroll-m-20 border-orange-500/20">
                <CardHeader>
            ...
            {filterCard(t.docs.riskRadar.assetConcentration.title, t.docs.riskRadar.assetConcentration.description) && (
              <Card id="asset-concentration" className="bg-background/40 backdrop-blur-md scroll-m-20 border-orange-500/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-base text-orange-400">
                    <AlertTriangle className="h-5 w-5" />
            ...
            {filterCard(t.docs.riskRadar.payoutRisk.title, t.docs.riskRadar.payoutRisk.description) && (
              <Card id="payout-risk" className="bg-background/40 backdrop-blur-md scroll-m-20 border-red-500/20">
                <CardHeader>
            ...
            {filterCard(t.docs.riskRadar.yieldTrap.title, t.docs.riskRadar.yieldTrap.description) && (
              <Card id="yield-trap" className="bg-background/40 backdrop-blur-md scroll-m-20 border-red-500/20">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-base text-red-400">
                    <AlertTriangle className="h-5 w-5" />
            ...
            {/* Glossary */}
            <h2 className="text-2xl font-bold tracking-tight mt-8 mb-4 border-b border-border pb-2">{t.docs.glossary.title}</h2>
