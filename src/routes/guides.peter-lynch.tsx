...
const PAGE_URL = `${SITE_URL}/guides/peter-lynch`;
const OG_IMAGE =
...
export const Route = createFileRoute("/guides/peter-lynch")({
  ...
  head: ({ loaderData }) => {
    ...
    const S = dict[locale].seoGuides.peterLynch;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Peter Lynch", item: urlFor(locale) },
            ],
          }),
        },
        {
  ...
  component: () => <GuidesPage defaultTab="peter-lynch" />,
