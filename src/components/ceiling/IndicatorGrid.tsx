...
export function IndicatorGrid({ asset }: { asset: Asset }) {
  ...
  if (asset.type === "ETF") {
    tiles = [
      { label: t.metrics.expenseRatio, value: n(m.expenseRatio, (x) => formatPercent(x, locale, 2)) },
      ...
      { label: t.metrics.dividendCagr5y, value: n(m.dividendCagr5y, (x) => formatPercent(x, locale, 2)) },
    ];
