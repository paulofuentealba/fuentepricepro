...
export function ConsensusPyramid({ valuation, currency }: ConsensusPyramidProps) {
  ...
  const renderVertex = (vertex: VertexConfig) => {
    ...
    return (
      ...
      >
        <div className="rounded-md border border-border/70 bg-card/90 px-3 py-1.5 backdrop-blur-md shadow-sm flex flex-col items-center">
  ...
  return (
    <>
      <div className="mb-6 rounded-xl border border-border/80 bg-card p-6 shadow-sm relative overflow-hidden">
        ...
        <h3 className="mb-8 text-center text-xs font-semibold text-muted-foreground uppercase tracking-widest">
        ...
        <div className="relative w-full max-w-[320px] mx-auto h-[260px]">
          ...
          <div className="absolute top-[140px] left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center z-10">
            ...
            <div className="relative rounded-full border border-primary/40 bg-card px-5 py-2.5 shadow-sm backdrop-blur-xl">
              <span className="flex items-center justify-center gap-1 text-[10px] font-bold text-primary uppercase tracking-widest text-center mb-0.5">
